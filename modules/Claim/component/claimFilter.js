(function () {
    'use strict';
    app.component('claimFilter', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, $window, commonService) {
            return "modules/Claim/component/claimFilter.html";
        },
        bindings: {
            searchResultModel: '=?',
            filterModel: '=?',
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, pageLoading, dpMessageBox, localStorageService, commonService, claimFactory, webServiceAPI) {
            var $vm = this;
            ...
            $vm.triggerSearch = function () {
                ...
                viewModel.FilterSearch($vm.filterModel).then(function (res) {
                    ...
                    if (res.data.itemsClaim.length != 0) {
                        ...
                        $vm.searchResultModel = res.data.itemsClaim;
                    }
                    else {
                        $vm.searchResultModel = res.data.itemsClaim;
                    }
            ...
            $scope.filterSearch = function () {
                ...
                //     if ($scope.filterModel.claim_Index == "" || $scope.filterModel.claim_Index.length < 36) //|| $scope.filterModel.planGoodsReceive_Index.length < 36
                //     {
                //         $scope.filterModel.claim_Index = "00000000-0000-0000-0000-000000000000";
                //     }
                // }
            ...
            $scope.convertDate = function () {
                ...
                if ($scope.filterModel.date != null) {
                    ...
                    $scope.filterModel.Claim_Date = YStart.toString() + MStart.toString() + DStart.toString();

                    var DEnd = str.substring(15, 13);
                    var MEnd = str.substring(18, 16);
                    var YEnd = str.substring(25, 19);

                    $scope.filterModel.Claim_Date_To = YEnd.toString() + MEnd.toString() + DEnd.toString();
                }
            ...
            $scope.autoComplete = {
                ...
                autoClaim: "Claim/autobasicSuggestion",
                ShopRef: "Claim/autoShopRef",
                autoVender: "Claim/autobasicSuggestionVender",
            ...
            this.$onInit = function () {
                ...
                $scope.filterModel.Claim_Date_To = getToday();
