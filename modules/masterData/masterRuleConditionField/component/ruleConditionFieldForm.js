(function() {
    ...
    app.component('ruleConditionFieldForm', {
        controllerAs: '$vm',
        templateUrl: function($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/masterData/masterRuleConditionField/component/ruleConditionFieldForm.html";
        },
        bindings: {
            onShow: '=?',
            filterModel: '=?',
        },
        controller: function($scope, $q, $filter, $http, /*ngAuthSettings,*/ $state, /*authService*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, ruleConditionFieldFactory, webServiceAPI) {
            var $vm = this;
            $scope.onShow = false;
            var defer = {};
            ...
            $vm.onShow = function(param) {
                ...
                if (param != undefined) {
                    pageLoading.show();
                    $scope.create = false;
                    viewModel.find(param.ruleConditionField_Index).then(function(res) {
                        pageLoading.hide();
            ...
            $scope.add = function() {
                ...
                $scope.validateMsg = "";
                if (model.ruleConditionField_Name == undefined || model.ruleConditionField_Name == "") {
                    dpMessageBox.alert({
                        ok: 'Close',
                        title: 'Validate',
