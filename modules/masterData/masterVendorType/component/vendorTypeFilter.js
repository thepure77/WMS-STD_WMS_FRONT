(function () {
    ...
    app.component('vendorTypeFilter', {
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService,vendorTypeFactory, webServiceAPI) {
            var $vm = this;
            ...
            $scope.autoComplete = {
                vendorType: "Autocomplete/autoSearchVendorType",
            };
