app.component('vendorTableList', {
    controllerAs: '$vm',
    templateUrl: "modules/masterData/masterVendor/component/vendorTableList.html",
    bindings: {
        searchResultModel: '=?',
        filterModel: '=?',
        triggerSearch: "=?",
    ...
    controller: function($scope, $filter, $q, $state, pageLoading, commonService, localStorageService, $timeout, $translate, dpMessageBox, vendorFactory) {
        var $vm = this;
