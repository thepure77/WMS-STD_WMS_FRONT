(function () {
    ...
    app.component('locationEquipmentFilter', {
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService,locationEquipmentFactory,webServiceAPI) {
            var $vm = this;
            ...
            $scope.autoComplete = {
                locationEquipmentName: "autoLocationEquipment/autoSearchLocationEquipmentFilter"
            };
