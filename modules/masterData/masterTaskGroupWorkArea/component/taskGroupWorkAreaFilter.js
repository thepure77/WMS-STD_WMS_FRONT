(function () {
    'use strict';
    app.component('taskGroupWorkAreaFilter', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/masterData/masterTaskGroupWorkArea/component/taskGroupWorkAreaFilter.html";
        },
        bindings: {
            searchResultModel: '=?',
            filterModel: '=?',
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService,taskGroupWorkAreaFactory,webServiceAPI) {
            var $vm = this;
            ...
            $scope.autoComplete = {
                taskGroupWorkArea: "autoTaskGroupWorkArea/autoTaskGroupWorkAreaSearchFilter"
            };
