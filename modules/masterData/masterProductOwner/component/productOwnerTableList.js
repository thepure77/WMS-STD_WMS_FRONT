'use strict'
app.component('productOwnerTableList', {
    controllerAs: '$vm',
    templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
        return "modules/masterData/masterProductOwner/component/productOwnerTableList.html";
    },
    bindings: {
        searchResultModel: '=?',
        filterModel: '=?',
    ...
    controller: function ($scope, $filter, $q, $compile, $http, /*ngAuthSettings,*/ $state, /*authService,*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox,productOwnerFactory) {
        var $vm = this;
        var XFindItem = $filter('findItemList');
        var Progressbar = pageLoading;

        let viewModel = productOwnerFactory;
        $scope.items = [];
        ...
        //     if ($scope.onShow) {
        //         $vm.isFilter = false;                
        //         $scope.onShow(param.productOwnerIndex).then(function (result) {
        //             $vm.isFilter = true;
        ...
        //     }).then(function success() {
        //         viewModel.getDelete(param.productOwnerIndex).then(function success(res) {
        //             $vm.triggerSearch();
        //         }, function error(res) { });
        //     });
        // };
