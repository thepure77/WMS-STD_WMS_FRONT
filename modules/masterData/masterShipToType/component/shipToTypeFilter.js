(function () {
    'use strict';
    app.component('shipToTypeFilter', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/masterData/masterShipToType/component/shipToTypeFilter.html";
        },
        bindings: {
            searchResultModel: '=?',
            filterModel: '=?',
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService,shipToTypeFactory,webServiceAPI) {
            var $vm = this;
            ...
            $scope.searchFilter = function (param) {
                ...
                viewModel.filter($scope.filterModel).then(function (res) {
                    ...
                    if (res.data.length != 0) {
                        ...
                        $vm.searchResultModel = res.data.itemsShipToType;
                    }
                    else {
            ...
            $scope.autoComplete = {
                shipToTypeName: "autoShipToType/autoSearchShipToTypeFilter"
            };
