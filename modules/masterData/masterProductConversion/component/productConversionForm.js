...
(function () {
    ...
    app.component('productConversionForm', {
        ...
        controller: function ($scope, $q, $filter, $http, /*ngAuthSettings,*/ $state, /*authService*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, productConversionFactory, productFactory, productConversionBarcodeFactory, webServiceAPI,Upload) {
            var $vm = this;
            $scope.onShow = false;
            var defer = {};
