(function () {
    'use strict';
    app.component('taskGroupEquipmentFilter', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/masterData/mastertaskGroupEquipment/component/taskGroupEquipmentFilter.html";
        },
        bindings: {
            searchResultModel: '=?',
            filterModel: '=?',
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService,taskGroupEquipment,webServiceAPI) {
            var $vm = this;
            ...
            $scope.autoComplete = {
                taskGroupEquipment: "autoTaskGroupEquipment/autoTaskGroupEquipmentSearchFilter"
            };
