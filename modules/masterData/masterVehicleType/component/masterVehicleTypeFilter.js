(function () {
    'use strict';
    app.component('masterVehicleTypeFilter', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/masterData/masterVehicleType/component/masterVehicleTypeFilter.html";
        },
        bindings: {
            searchResultModel: '=?',
            filterModel: '=?',
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService,masterVehicleTypeFactory,webServiceAPI) {
            var $vm = this;
            ...
            $scope.autoComplete = {
                ItemStatusName: "Autocomplete/autoVehicleType"
            };
