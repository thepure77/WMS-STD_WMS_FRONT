(function () {
    ...
    app.component('soldToShipToFilter', {
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService,soldToShipToFactory,webServiceAPI) {
            var $vm = this;
            ...
            $scope.autoComplete = {
                soldToShipTo: "autoSoldToShipTo/autoSearchSoldToShipToFilter"
            };
