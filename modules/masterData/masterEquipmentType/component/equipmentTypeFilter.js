(function () {
    'use strict';
    app.component('equipmentTypeFilter', {
        controllerAs: '$vm',
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService,equipmentTypeFactory,webServiceAPI) {
            var $vm = this;
            ...
            $scope.autoComplete = {
                equipmentTypeName: "autoEquipmentType/autoSearchEquipmentTypeFilter"
            };
