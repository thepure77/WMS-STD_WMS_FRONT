(function () {
    ...
    app.component('productSubTypeFilter', {
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService,productSubTypeFactory, webServiceAPI) {
            var $vm = this;
            ...
            $scope.autoComplete = {
                productSubType: "Autocomplete/autoSearchProductSubType",
            };
