(function () {
    'use strict'
    app.component('masterDockTypeForm', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/masterData/masterDockType/component/masterDockTypeForm.html";
        },
        bindings: {
            onShow: '=?',
            searchResultModel: '=?',
        ...
        controller: function ($scope, $q, $filter, $state, pageLoading, $window, dpMessageBox, localStorageService, masterDockTypeFactory, webServiceAPI, facilityFactory) {
            var $vm = this;
            ...
            $scope.add = function () {
                ...
                if (model.dockType_Index == undefined) {
