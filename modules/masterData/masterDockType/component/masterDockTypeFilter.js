(function () {
    'use strict';
    app.component('masterDockTypeFilter', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/masterData/masterDockType/component/masterDockTypeFilter.html";
        },
        bindings: {
            searchResultModel: '=?',
            filterModel: '=?',
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService,masterDockTypeFactory,webServiceAPI) {
            var $vm = this;

            // ----------------------------------------------------
            // This default object
            var viewModel = masterDockTypeFactory;
            $scope.filterModel = {};
            $vm.filterModel = {
                currentPage: 1,
                PerPage: 50,
            ...
            $scope.searchFilter = function (param) {
                ...
                viewModel.filter($scope.filterModel).then(function (res) {
                    ...
                    if (res.data.length != 0) {
                        ...
                        $vm.searchResultModel = res.data.dockTypeModels;
                    }
                    else {
