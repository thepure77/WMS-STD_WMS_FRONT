// 'use strict'
// app.component('masterEquipmentTableList', {
//     controllerAs: '$vm',
//     templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
//         return "modules/masterData/masterEquipment/component/equipmentTableList.html";
//     },
//     bindings: {
//         searchResultModel: '=?',
//         filterModel: '=?',
...
//         isFilter: '=?'
//     },
//     controller: function ($scope, $filter, $q, $compile, $http, /*ngAuthSettings,*/ $state, /*authService,*/ pageLoading, $window, commonService, localStorageService, $timeout, dpMessageBox,equipmentFactory) {
//         var $vm = this;
//         var XFindItem = $filter('findItemList');
//         var Progressbar = pageLoading;
//         $scope.items = [];
//         $scope.items = $scope.items || [];
//         let viewModel = equipmentFactory;
//         // setting column
...
//             if ($scope.onShow) {
//                 $vm.isFilter = false;                
//                 $scope.onShow(param.equipmentIndex).then(function (result) {
//                     $vm.isFilter = true;
...
//                 viewModel.getDelete(param.equipmentIndex).then(function success(res) {
//                     $vm.triggerSearch();
//                 }, function error(res) { });
//             });
//         };
...
app.component('masterEquipmentTableList', {
    ...
    controller: function ($scope, $filter, $q, $compile, $http, /*ngAuthSettings,*/ $state, /*authService,*/ pageLoading, $window, localStorageService, dpMessageBox,equipmentFactory) {
        var $vm = this;        
        var Progressbar = pageLoading;
        $scope.items = [];
        $scope.items = $scope.items || [];
