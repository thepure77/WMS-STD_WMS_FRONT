(function () {
    'use strict';
    app.component('masterYardTypeFilter', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/masterData/masterYardType/component/masterYardTypeFilter.html";
        },
        bindings: {
            searchResultModel: '=?',
            filterModel: '=?',
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService,masterYardTypeFactory,webServiceAPI) {
            var $vm = this;
            ...
            $scope.searchFilter = function (param) {
                ...
                viewModel.filter($scope.filterModel).then(function (res) {
                    ...
                    if (res.data.length != 0) {
                        ...
                        $vm.searchResultModel = res.data.yardTypeModels;
                    }
                    else {
