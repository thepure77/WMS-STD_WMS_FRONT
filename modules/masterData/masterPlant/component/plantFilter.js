            ...
            $scope.export = function () {
                ...
                viewModel.Export($scope.exportModel).then(function (res) {
                    ...
                    if (res.data.length != 0) {
                        ...
                        /* XLS Head Columns */
                        var xlsHeader = ["No.","Plant Id", "Plant Name","Plant Type","Create By","Create Date","Update By","Update Date","Cancle By","Cancle Date","Active Status"];
                        ...
                        pageLoading.hide();
                        JSONToCSVConvertor(createXLSLFormatObj, "Plant");
                    } else {
                        $vm.ResultModelExcel = res.data.itemsPlant;
                    }
                });
