(function () {
    'use strict';
    app.component('locationWorkAreaFilter', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/masterData/masterlocationWorkArea/component/locationWorkAreaFilter.html";
        },
        bindings: {
            searchResultModel: '=?',
            filterModel: '=?',
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService,locationWorkAreaFactory,webServiceAPI) {
            var $vm = this;
            ...
            $scope.autoComplete = {
                locationWorkAreaName: "autoLocationWorkArea/autoLocationSearchFilter"
            };
