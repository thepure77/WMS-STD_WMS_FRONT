(function () {
    'use strict';
    app.component('productTypeFilter', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/masterData/masterProductType/component/productTypeFilter.html";
        },
        bindings: {
            searchResultModel: '=?',
            filterModel: '=?',
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService,productTypeFactory, webServiceAPI) {
            var $vm = this;
            ...
            $scope.autoComplete = {
                productType: "Autocomplete/autoSearchProductType",
            };
