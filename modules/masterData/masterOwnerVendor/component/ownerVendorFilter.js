(function () {
    ...
    app.component('ownerVendorFilter', {
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService,ownerVendorFactory, webServiceAPI) {
            var $vm = this;
            ...
            $scope.autoComplete = {
                ownerVendor: "autoOwnerVendor/autoOwnerVendor",
            };
