'use strict'
app.component('ownerVendorTableList', {
    controllerAs: '$vm',
    templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
        return "modules/masterData/masterOwnerVendor/component/ownerVendorTableList.html";
    },
    bindings: {
        searchResultModel: '=?',
        filterModel: '=?',
    ...
    controller: function ($scope, $filter, $q, $compile, $http, /*ngAuthSettings,*/ $state, /*authService,*/ pageLoading, $window, commonService, localStorageService, $timeout, dpMessageBox,ownerVendorFactory) {
        var $vm = this;
        //var XFindItem = $filter('findItemList');
        var Progressbar = pageLoading;
     
        let viewModel = ownerVendorFactory;
        $scope.items = [];
