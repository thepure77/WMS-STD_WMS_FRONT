(function () {
    'use strict'
    app.component('masterCarrierTypeForm', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/masterData/masterCarrierType/component/masterCarrierTypeForm.html";
        },
        bindings: {
            onShow: '=?',
            searchResultModel: '=?',
        ...
        controller: function ($scope, $q, $filter, $state, pageLoading, $window, dpMessageBox, localStorageService, masterCarrierTypeFactory, webServiceAPI, facilityFactory) {
            var $vm = this;
