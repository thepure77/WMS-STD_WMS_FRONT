(function () {
    'use strict';
    app.component('locationlockFilter', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/masterData/masterLocationLock/component/locationlockFilter.html";
        },
        bindings: {
            searchResultModel: '=?',
            filterModel: '=?',
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService,locationLockFactory,webServiceAPI) {
            var $vm = this;
            ...
            $scope.autoComplete = {
                LocationAisleName: "autoLocationAisle/autoSearchLocationAisleFilter"
            };
            ...
            $scope.export = function () {
                ...
                viewModel.Export($scope.exportModel).then(function (res) {
                    ...
                    debugger
                    if (res.data.length != 0) {
                        $vm.ResultModelExcel = res.data.itemsLocationAisle;
                        ...
                        $vm.ResultModelExcel.forEach(e => {
                            xlsRows.push({
                                "ลำดับ":e.numBerOf,
                                "LOCATION LOCK ID": e.locationLock_Id,
                                "LOCATION LOCK NAME": e.locationLock_Name,
                        ...
                        pageLoading.hide();
                        JSONToCSVConvertor(createXLSLFormatObj, "LocationAisle");
                    } else {
                        $vm.ResultModelExcel = res.data.itemsLocationAisle;
                    }
                });
