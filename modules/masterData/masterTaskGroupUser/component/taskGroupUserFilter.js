(function () {
    ...
    app.component('taskGroupUserFilter', {
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService,taskGroupUserFactory,webServiceAPI) {
            var $vm = this;
            ...
            $scope.autoComplete = {
                taskGroupUser: "autoTaskGroupUser/autoTaskGroupUserSearchFilter"
            };
