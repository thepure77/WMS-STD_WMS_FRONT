(function() {
    ...
    app.component('roomFilter', {
        ...
        controller: function($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService, roomFactory, webServiceAPI,dpMessageBox) {
            var $vm = this;
            ...
            $vm.triggerSearch = function() {
                ...
                viewModel.filter($vm.filterModel).then(function(res) {
                    ...
                    if (res.data.length != 0) {
                        ...
                        $vm.searchResultModel = res.data.itemsRoom;
                    } else {
                        $vm.searchResultModel = res.data.itemsRoom;
                    }
                });
            ...
            $scope.autoComplete = {
                room: "Autocomplete/autoSearchRoom",
            };
            ...
            $scope.export = function () {
                ...
                viewModel.Export($scope.exportModel).then(function (res) {
                    ...
                    debugger
                    if (res.data.length != 0) {
                        $vm.ResultModelExcel = res.data.itemsRoom;
                        ...
                        $vm.ResultModelExcel.forEach(e => {
                            xlsRows.push({
                                ...
                                "WAREHOUSE NAME":e.warehouse_Name,
                        ...
                        pageLoading.hide();
                        JSONToCSVConvertor(createXLSLFormatObj, "Room");
                    } else {
                        $vm.ResultModelExcel = res.data.itemsRoom;
                    }
                });
