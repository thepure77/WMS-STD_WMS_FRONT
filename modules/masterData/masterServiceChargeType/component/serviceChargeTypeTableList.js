'use strict'
app.component('serviceChargeTypeTableList', {
    controllerAs: '$vm',
    templateUrl: function($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
        return "modules/masterData/masterServiceChargeType/component/serviceChargeTypeTableList.html";
    },
    bindings: {
        searchResultModel: '=?',
        filterModel: '=?',
    ...
    controller: function($scope, $filter, $q, $compile, $http, /*ngAuthSettings,*/ $state, /*authService,*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, serviceChargeTypeFactory) {
        var $vm = this;
                ...
                viewModel.filter(data).then(function (res) {
                    ...
                    if (res.data.length != 0 && res.data.length != undefined) {
                        ...
                        if (res.data.pagination != null) {
                            ...
                            $vm.searchResultModel = res.data.itemsWarehouse;
                ...
                viewModel.getDelete(param).then(function success(res) {
                    if (res.data == true) {
                        dpMessageBox.alert({
                            ok: 'Close',
                            title: 'Success',
                            message: 'MSG_Alert_Delete_Success'
                        })
                    }
                    $vm.triggerSearch();
                }, function error(res) {});
