'use strict'
app.component('productLocationTableList', {
    controllerAs: '$vm',
    templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
        return "modules/masterData/masterproductLocation/component/productLocationTableList.html";
    },
    bindings: {
        searchResultModel: '=?',
        filterModel: '=?',
    ...
    controller: function ($scope, $filter, $q, $compile, $http, /*ngAuthSettings,*/ $state, /*authService,*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox,productLocationFactory) {
        var $vm = this;
                ...
                viewModel.filter(data).then(function (res) {
                    ...
                    if (res.data.length != 0 && res.data.length != undefined) {
                        ...
                        if (res.data.pagination != null) {
                            ...
                            $vm.searchResultModel = res.data.itemsProductLocation;
