app.component('warehouseOwnerTableList', {
    controllerAs: '$vm',
    templateUrl: "modules/masterData/masterWHOwner/component/whOwnerTableList.html",
    bindings: {
        searchResultModel: '=?',
        filterModel: '=?',
        triggerSearch: "=?",
    ...
    controller: function($scope, $filter, $q, $state, pageLoading, commonService, localStorageService, $timeout, $translate, dpMessageBox, warehouseOwnerFactory) {
        var $vm = this;
