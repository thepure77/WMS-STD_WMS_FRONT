(function () {
    ...
    app.component('productFilter', {
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService, productFactory, productConversionFactory, productOwnerFactory, ownerFactory, webServiceAPI, importFileMasterFactory) {
            var $vm = this;
            // ----------------------------------------------------
            // This default object
