 ...
 (function() {
    'use strict'
    app.directive('containerTypePopupTable', function() {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/masterData/component/containerTypePopup/containerTypePopupTable/containerTypePopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
