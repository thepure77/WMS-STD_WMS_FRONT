 ...
 (function() {
    'use strict'
    app.directive('productTypePopupTable', function() {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/masterData/component/productTypePopup/productTypePopupTable/productTypePopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
