 ...
 (function() {
    'use strict'
    app.directive('ruleputawayConditionFieldPopupTable', function() {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/masterData/component/ruleputawayConditionFieldPopup/ruleputawayConditionFieldPopupTable/ruleputawayConditionFieldPopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
