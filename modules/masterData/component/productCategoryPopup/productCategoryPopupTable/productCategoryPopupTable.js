 ...
 (function() {
    'use strict'
    app.directive('productCategoryPopupTable', function() {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/masterData/component/productCategoryPopup/productCategoryPopupTable/productCategoryPopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
