 ...
 (function() {
    'use strict'
    app.directive('locationTypePopupTable', function() {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/masterData/component/locationTypePopup/locationTypePopupTable/locationTypePopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
