 ...
 (function() {
    'use strict'
    app.directive('vehicleTypePopupTable', function() {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/masterData/component/vehicleTypePopup/vehicleTypePopupTable/vehicleTypePopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
