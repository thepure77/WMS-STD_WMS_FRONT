 ...
 (function() {
    'use strict'
    app.directive('ruleConditionOperationPopupTable', function() {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/masterData/component/ruleConditionOperationPopup/ruleConditionOperationPopupTable/ruleConditionOperationPopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
