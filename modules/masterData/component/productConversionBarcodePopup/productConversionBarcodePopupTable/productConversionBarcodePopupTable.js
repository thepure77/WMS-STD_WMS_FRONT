(function() {
    'use strict'
    app.directive('productConversionBarcodePopupTable', function() {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/masterData/component/productConversionBarcodePopup/productConversionBarcodePopupTable/productConversionBarcodePopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
            ...
            controller: ['$scope', 'commonService', '$filter','dpMessageBox','productConversionBarcodePopupFactory','$q', function($scope, commonService, $filter,dpMessageBox,productConversionBarcodePopupFactory,$q) {
                ...
                $scope.delegate = {
                    set: function(model, ProductConversionIndex) {
                        $scope.productConversion_Index = ProductConversionIndex;
                        $scope.items = model;
                    },
                ...
                function Add(select) {
                    debugger
                    $scope.ItemObj = {};
                    $scope.ItemObj.productConversion_Index = $scope.productConversion_Index;
                    $scope.ItemObj.listProductConversionItemViewModel = select;
