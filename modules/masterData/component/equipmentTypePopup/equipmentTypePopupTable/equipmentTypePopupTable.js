 ...
 (function() {
    'use strict'
    app.directive('equipmentTypePopupTable', function() {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/masterData/component/equipmentTypePopup/equipmentTypePopupTable/equipmentTypePopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
