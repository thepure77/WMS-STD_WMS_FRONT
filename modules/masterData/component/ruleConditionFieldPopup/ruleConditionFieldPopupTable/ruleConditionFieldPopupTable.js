 ...
 (function() {
    'use strict'
    app.directive('ruleConditionFieldPopupTable', function() {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/masterData/component/ruleConditionFieldPopup/ruleConditionFieldPopupTable/ruleConditionFieldPopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
