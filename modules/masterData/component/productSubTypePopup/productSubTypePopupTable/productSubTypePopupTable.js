 ...
 (function() {
    'use strict'
    app.directive('productSubTypePopupTable', function() {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/masterData/component/productSubTypePopup/productSubTypePopupTable/productSubTypePopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
