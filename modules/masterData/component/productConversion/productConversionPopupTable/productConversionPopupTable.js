 ...
 (function() {
    'use strict'
    app.directive('productConversionPopupTable', function() {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/masterData/component/productConversion/productConversionPopupTable/productConversionPopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
