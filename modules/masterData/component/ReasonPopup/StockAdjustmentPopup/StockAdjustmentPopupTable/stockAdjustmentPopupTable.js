 ...
 (function() {
    'use strict'
    app.directive('stockAdjustmentPopupTable', function() {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/Tranfer/component/StockAdjustmentPopup/StockAdjustmentPopupTable/stockAdjustmentPopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
