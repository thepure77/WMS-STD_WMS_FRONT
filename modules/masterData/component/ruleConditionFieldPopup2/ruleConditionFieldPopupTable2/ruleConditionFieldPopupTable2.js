 ...
 (function() {
    'use strict'
    app.directive('ruleConditionFieldPopupTable2', function() {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/masterData/component/ruleConditionFieldPopup2/ruleConditionFieldPopupTable2/ruleConditionFieldPopupTable2.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
