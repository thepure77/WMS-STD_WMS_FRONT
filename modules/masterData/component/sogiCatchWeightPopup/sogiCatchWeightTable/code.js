 ...
 (function() {
    'use strict'
    app.directive('sogiCatchWeightPopupTable', function() {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/masterData/component/sogiCatchWeightPopup/sogiCatchWeightTable/view.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
            ...
            controller: ['$scope', 'commonService', '$filter', function($scope, commonService, $filter) {
                ...
                $scope.selected = function(param, mode) {
