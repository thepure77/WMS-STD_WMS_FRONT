...
(function () {
    'use strict'
    app.directive('sogiCatchWeightPopup', ['ngAuthSettings', '$window', 'commonService', 'pageLoading', '$timeout',
        function (ngAuthSettings, $window, commonService, pageLoading, $timeout) {
            return {
                restrict: 'E',
                controllerAs: '$ctrl',
                templateUrl: "modules/masterData/component/sogiCatchWeightPopup/view.html",
                scope: {
                    onShow: '=',
                    delegates: '=?',
                    invokes: '=?',
