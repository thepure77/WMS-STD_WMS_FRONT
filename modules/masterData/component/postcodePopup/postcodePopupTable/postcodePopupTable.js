 ...
 (function() {
    'use strict'
    app.directive('postcodePopupTable', function() {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/masterData/component/postcodePopup/postcodePopupTable/postcodePopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
            ...
            controller: ['$scope', 'commonService', '$filter', function($scope, commonService, $filter) {
                ...
                $scope.delegate = {
                    set: function(model, paginations) {
                        if(model.itemsPostcode.length != 0){
                            if(model != null){
