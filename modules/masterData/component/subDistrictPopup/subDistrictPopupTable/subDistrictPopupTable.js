 ...
 (function() {
    'use strict'
    app.directive('subDistrictPopupTable', function() {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/masterData/component/subDistrictPopup/subDistrictPopupTable/subDistrictPopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
