 ...
 (function() {
    'use strict'
    app.directive('locationLockPopupTable', function() {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/masterData/component/locationLockPopup/locationLockPopupTable/locationLockPopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
