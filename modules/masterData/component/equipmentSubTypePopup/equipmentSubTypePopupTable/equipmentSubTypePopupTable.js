 ...
 (function() {
    'use strict'
    app.directive('equipmentSubtypePopupTable', function() {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/masterData/component/equipmentSubTypePopup/equipmentSubTypePopupTable/equipmentSubTypePopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
