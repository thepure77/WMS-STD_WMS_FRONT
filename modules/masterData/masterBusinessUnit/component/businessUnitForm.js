            ...
            $scope.add = function() {
                ...
                if (model.businessUnit_Id != "") {
                    if (!model.businessUnit_Id.match(/^([a-z0-9])+$/i)) {
                        dpMessageBox.alert({
                            ok: 'Close',
                            title: 'แจ้งเตือน',
                            message: 'รหัสกลุ่มธุรกิจไม่ถูกต้อง'
                        })
                        return "";
                    } else {
                ...
                if (model.businessUnit_Id == undefined || model.businessUnit_Id == "") {
                    dpMessageBox.alert({
                        ok: 'Close',
                        title: 'แจ้งเตือน',
                        message: 'กรุณากรอกรหัสกลุ่มธุรกิจ'
                    })
                    return "";
                }
                if (model.businessUnit_Name == undefined || model.businessUnit_Name == "") {
                    dpMessageBox.alert({
                        ok: 'Close',
                        title: 'แจ้งเตือน',
                        message: 'กรุณากรอกชื่อกลุ่มธุรกิจ'
                    })
                    return "";
                }
                if (model.businessUnit_SecondName == undefined || model.businessUnit_SecondName == "") {
                    dpMessageBox.alert({
                        ok: 'Close',
                        title: 'แจ้งเตือน',
                        message: 'กรุณากรอกชื่อกลุ่มธุรกิจ 2'
                    })
                    return "";
                } 
                else {
