(function () {
    ...
    app.component('locationTypeFilter', {
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService,locationTypeFactory,webServiceAPI) {
            var $vm = this;
            ...
            $scope.$on('$destroy', function () {
             ...
             $scope.export = function () {
                ...
                viewModel.Export($scope.exportModel).then(function (res) {
                    ...
                    debugger
                    if (res.data.length != 0) {
                        $vm.ResultModelExcel = res.data.itemsLocationType;
                        ...
                        $vm.ResultModelExcel.forEach(e => {
                            xlsRows.push({
                                "ลำดับ":e.numBerOf,
                                "LOCATION TYPE ID": e.locationType_Id,
                        ...
                        pageLoading.hide();
                        JSONToCSVConvertor(createXLSLFormatObj, "LocationType");
                    } else {
                        $vm.ResultModelExcel = res.data.itemsLocationType;
                    }
                });
