(function () {
    'use strict';
    app.component('masterEquipmentSubtypeFilter', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/masterData/masterEquipmentSubType/component/equipmentSubTypeFilter.html";
        },
        bindings: {
            searchResultModel: '=?',
            filterModel: '=?',
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService,equipmentSubTypeFactory,webServiceAPI) {
            var $vm = this;
            ...
            $scope.autoComplete = {
                equipmentSubTypeName: "autoEquipmentSubType/autoSearchEquipmentSubTypeFilter"
            };
