(function () {
    'use strict'
    app.component('masterItemStatusForm', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/masterData/masterItemStatus/component/masterItemStatusForm.html";
        },
        bindings: {
            onShow: '=?',
            searchResultModel: '=?',
        ...
        controller: function ($scope, $q, $filter, /*ngAuthSettings,*/ $state, /*authService*/ pageLoading, $window, dpMessageBox,localStorageService, masterItemStatusFactory, webServiceAPI) {
            var $vm = this;
