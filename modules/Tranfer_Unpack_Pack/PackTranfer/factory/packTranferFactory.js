(function () {
    'use strict';
    app.factory("packTranferFactory",
        function ($q, $http, ngAuthSettings, localStorageService,  webServiceAPI, clientService) {
            ...
            return {
                ...
                filterTaskUnpack: function (model) {
                    ...
                    var urlRequest = this.urlTransfer + "/FilterGoodsTransferPack";
                    return clientService.post(urlRequest, model);
                },
                filterbinbalance_pack: function (model) {
                    debugger
                    var urlRequest = this.urlBinbalance + "/filterbinbalance_pack";
                    return clientService.post(urlRequest, model);
                },
                goodsissueHeader: function (model) {
                    var urlRequest = this.urlUnback + "/pack";
                    return clientService.post(urlRequest, model);
                },
