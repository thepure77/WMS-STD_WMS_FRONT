(function () {
    'use strict';
    app.component('tranferUnpackForm', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, $window, commonService) {
            return "modules/Tranfer_Unpack_Pack/Unpack/component/tranferUnpackForm.html";
        },
        bindings: {
            scanReceive: '=?',
            onShow: '=?'
        },
        controller: function ($scope, $q, $filter, $http, $state, pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, webServiceAPI, tranferUnpackFactory) {
            var $vm = this;
            var defer = {};
            var viewModelunPack = tranferUnpackFactory
            ...
            $scope.selected = function (model) {
                ...
                // }
                    ...
                    // model.create_by = $scope.username;
                    viewModelunPack.goodsissueHeader(model).then(
            ...
            $scope.save = function () {
                ...
                $scope.model.items = $scope.filterModel;
