(function () {
    ...
    app.component('unpackpickForm', {
        controllerAs: '$vm',
        templateUrl: "modules/Tranfer_Unpack_Pack/TransferUnpack/component/unpackpickForm.html",
        bindings: {
            isLoading: '=?',
            onShow: '=?',
            searchResultModel: '=?',
        ...
        controller: function ($scope, $q, $filter, $http, /*ngAuthSettings,*/ $state, /*authService*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, planGoodsReceiveFactory, planGoodsReceiveItemFactory, planGoodsIssueItemFactory, ownerPopFactory, webServiceAPI, transferUnpackFactory, goodIssueFactory) {
            ...
            var __viewModel = transferUnpackFactory;
                ...
                invokes: {
                    ...
                    selected: function (param) {
                        ...
                        if ($scope.formPgae == "GI") {
                            ...
                            transferUnpackFactory.pickProduct(param).then(function (res) {
                                pageLoading.hide()
                                if (res.data.resultIsUse) {
                                    $scope.itemsReserve.item = $scope.itemsReserve.item || [];
                                    $scope.itemsReserve.item.push(angular.copy(res.data.items));
            ...
            $scope.Confirm = function () {
                ...
                if ($scope.formPgae == "GI") {
                    ...
                    $state.go('wms.transfer_unpack_summary', {});
                }
            ...
            $scope.ok = function () {
                ...
                transferUnpackFactory.ListPickProduct(obj).then(function (res) {
                    pageLoading.hide()
            ...
            var init = function () {
                ...
                $scope.dataGT = transferUnpackFactory.getParam();
                if ($scope.dataGi) {
