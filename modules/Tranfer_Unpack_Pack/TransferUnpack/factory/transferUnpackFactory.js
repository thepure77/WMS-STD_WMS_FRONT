(function () {
    'use strict';
    app.factory("transferUnpackFactory",
        function ($q, $http, ngAuthSettings, localStorageService, webServiceAPI, clientService) {
            ...
            return {
                ...
                url: webServiceAPI.GT + "TransferUnpack",
                urlSRTN: webServiceAPI.GT + "ScanRefTransferNo",
                ...
                filterBinbalance: function (model) {
                    var urlRequest = this.urlBinbalance + "/filterUnpack";
                    return clientService.post(urlRequest, model);
                },
