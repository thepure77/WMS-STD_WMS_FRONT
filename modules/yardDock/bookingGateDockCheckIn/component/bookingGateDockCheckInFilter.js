(function () {
    'use strict';
    app.component('bookingGateDockCheckInFilter', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/yardDock/bookingGateDockCheckIn/component/bookingGateDockCheckInFilter.html";
        },
        bindings: {
            searchResultModel: '=?',
            filterModel: '=?',
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, dpMessageBox, bookingGateDockCheckInFactory, bkYardDockFactory, webServiceAPI) {
            var $vm = this;
