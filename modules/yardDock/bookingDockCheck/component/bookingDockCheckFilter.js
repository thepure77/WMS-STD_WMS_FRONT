(function () {
    'use strict';
    app.component('bookingDockCheckFilter', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/yardDock/bookingDockCheck/component/bookingDockCheckFilter.html";
        },
        bindings: {
            searchResultModel: '=?',
            filterModel: '=?',
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, dpMessageBox, bookingDockCheckFactory, bkYardDockFactory, webServiceAPI) {
            var $vm = this;
