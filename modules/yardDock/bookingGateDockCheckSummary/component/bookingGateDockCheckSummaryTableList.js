'use strict'
app.component('bookingGateDockCheckSummaryTableList', {
    controllerAs: '$vm',
    templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window) {
        return "modules/yardDock/bookingGateDockCheckSummary/component/bookingGateDockCheckSummaryTableList.html";
    },
    bindings: {
        searchResultModel: '=?',
        filterModel: '=?',
