'use strict'
app.component('scanInRework', {
    controllerAs: '$vm',
    templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
        return "modules/RollCage/scanInRework/scanInRework.html";
    ...
    controller: function ($scope, $filter, $q, $compile, $http, /*ngAuthSettings,*/ $state, /*authService,*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, scanInReworkFactory,reworkRollCageFactory, webServiceAPI, logsFactory) {
        var $vm = this;
        var XFindItem = $filter('findItemList');
        var Progressbar = pageLoading;
        $scope.items = $scope.items || [];
        var viewModel = scanInReworkFactory;
        ...
        $scope.ScanRollCage = function () {
            ...
            pageLoading.show();
            viewModel.scanRollCageActiveReworkChute($scope.filterModel).then(function success(res) {
                pageLoading.hide();
        ...
        $scope.SendRollCage = function () {
            $state.go('wms.send_rollcage', { a: "" });
        }
        ...
        var init = function () {
            ...
            if ($scope.dataRE) {
                ...
                $scope.checkChute.chute_Id = $scope.dataRE.chute_No;
                $scope.filterModel.rollCage_Id = $scope.dataRE.rollCage_Id;

                $scope.ScanRollCage();
            }
            else
            {
                $state.go('wms.rework_roll_cage');
