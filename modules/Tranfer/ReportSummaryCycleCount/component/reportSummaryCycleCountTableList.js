'use strict'
app.component('reportSummaryCycleCountTableList', {
    controllerAs: '$vm',
    templateUrl: function ($element, $attrs, $window, commonService) {
        return "modules/Tranfer/ReportSummaryCycleCount/component/reportSummaryCycleCountTableList.html";
    },
    bindings: {
        isLoading: '=?',
        searchResultModel: '=?',
    ...
    controller: function ($scope, $filter, $q, $compile, $http, $state, pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, reportSummaryCycleCountFactory,kMessageBox) {
        var $vm = this;
      ...
      function ExportPDF(result) {
        debugger
        var param = reportSummaryCycleCountFactory.getParam();
        var deferred = $q.defer();
        param.PdfName = "SummaryCycleCount";
        param.status_button = "PDF";
        param.cycleCount_No = result.cycleCount_No;
        
        viewModel.ExportPDF_SummaryCyclecount(param).then(
      ...
      function ExportExcel(result) {
        var param = reportSummaryCycleCountFactory.getParam();
        var deferred = $q.defer();
        param.excelName = "SummaryCycleCount";
        param.status_button = "Excel";
        param.cycleCount_No = result.cycleCount_No;
