(function () {
    'use strict'
    app.component('scanRefTransferNoExport', {
        controllerAs: '$vm',
        templateUrl: "modules/Tranfer/ScanRefTransferNoExport/component/scanRefTransferNoExport.html",
        bindings: {
            onShow: '=?',
            searchResultModel: '=?',
            filterModel: '=?',
        ...
        controller: function ($scope, $q, $filter, $state, pageLoading, $window, commonService, localStorageService, $timeout, dpMessageBox, scanRefTransferNoExportFactory, webServiceAPI,taskTransferExportFactory) {
            var $vm = this;
            var defer = {};
            $vm.isFilter = true;
            ...
            $scope.filterModel = {};
            var _viewModel = taskTransferExportFactory;
                    ...
                    if($scope.filterModel.IsTransferPalletInspection)
                    {
                        viewModel.UpdateRePutaway($scope.filterModel).then(function success(res) {
                            ...
                            if (res.data == "โอนย้ายเอกสารสำเร็จ") {
                                ...
                                init();
                                $state.go('wms.task_transfer_export', {});
