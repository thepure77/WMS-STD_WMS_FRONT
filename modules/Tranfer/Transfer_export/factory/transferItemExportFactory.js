app.factory("transferItemExportFactory", function (webServiceAPI, clientService) {
    return {
        get: clientService.get,
        post: clientService.post,
        url: webServiceAPI.GT + "TransferItemExport",
        ...
        checkLocationOnGround: function (model) {
            var urlRequest = this.url + "/CheckLocationOnGround";
            return clientService.post(urlRequest, model);
        },
    }
});