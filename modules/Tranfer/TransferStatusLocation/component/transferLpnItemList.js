(function () {
    'use strict'
    app.component('transferLpnItemList', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/Tranfer/TransferStatusLocation/component/transferLpnItemList.html";
        },
        bindings: {
            isLoading: '=?',
            searchResultModel: '=?',
        ...
        controller: function ($scope, $filter, $q, $compile, $state, pageLoading, commonService, localStorageService, $timeout, $translate, dpMessageBox, transferStatusLocationFactory) {
            var $vm = this;
            var defer = {};
