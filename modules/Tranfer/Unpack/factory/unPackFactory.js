(function () {
    'use strict';
    app.factory("unPack_Factory",
        function ($q, $http, ngAuthSettings, localStorageService,  webServiceAPI, clientService) {
 
            return {
                get: clientService.get,
                post: clientService.post,
                urlTransfer: webServiceAPI.GT + "Transfer",
                ...
                urlUnback: webServiceAPI.OMS  + "UnpackControllers",
                ...
                goodsissueHeader: function (model) {
                    var urlRequest = this.urlUnback + "/UnpackGI";
                    return clientService.post(urlRequest, model);
                },
                ...
                scanLocation: function (model) {
                    var urlRequest = this.urlTransferStatusLocation + "/ScanLocation" ;
                    return clientService.post(urlRequest, model);
                },
