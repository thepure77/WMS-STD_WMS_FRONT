(function () {
    ...
    function ($q, $http, ngAuthSettings, localStorageService,  webServiceAPI, clientService) {
        ...
        return {
            ...
            //     return clientService.post(urlRequest,model);
            // },
            ExportPDF_Cyclecount: function (model) {
                var urlRequest = this.url + "/ReportPrintCycleCount";
            ...
            dropdownRollCage: function (model) {
                var urlRequest = this.urlDropdown + "/dropdownRollCage";
                return clientService.post(urlRequest, model);
            },
