'use strict'
app.component('cyclecountTableListV2', {
    controllerAs: '$vm',
    templateUrl: function ($element, $attrs, $window, commonService) {
        return "modules/Tranfer/CyclecountV2/component/CyclecountTableListV2.html";
    },
    bindings: {
        isLoading: '=?',
        searchResultModel: '=?',
    ...
    controller: function ($scope, $filter, $q, $compile, $http, $state, pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, cyclecountFactory,kMessageBox) {
      ...
      function ExportPDF(param) {
        ...
        param.PdfName = "CycleCount";
        param.status_button = "PDF";
        debugger;
        viewModel.ExportPDF_Cyclecount(param).then(
