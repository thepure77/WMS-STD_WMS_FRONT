...
(function () {
    'use strict';
    app.component('bypassPartialFilter', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/Tranfer/BypassPartial/BypassPartial/bypassPartialFilter.html";
        },
        bindings: {
            searchResultModel: '=?',
            filterModel: '=?',
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService, bypassPartialFactory, webServiceAPI) {
            var $vm = this;
            ...
            $vm.triggerSearch = function () {
                ...
                viewModel.filter($vm.filterModel).then(function (res) {
                    pageLoading.hide();
                    if (res.data.itemsbypassPartial.length != 0) {
                        debugger
            ...
            $scope.export = function () {
                ...
                viewModel.Export($scope.exportModel).then(function (res) {
                    ...
                    if (res.data.length != 0) {
                        $vm.ResultModelExcel = res.data.itemsbypassPartial;

                        var createXLSLFormatObj = [];

                        /* XLS Head Columns */
                        var xlsHeader = ["Product ID", "Product Name", "Replenishment Location", "Location Name", "Tag No", "Qty Bal", "Qty Reserve", "Qty Remain","Sale Unit", "EXP Date","ShelfLife","AgeRemain","ERP Location","ItemStatus"];
                        ...
                        pageLoading.hide();
                        JSONToCSVConvertor(createXLSLFormatObj, "bypassPartial");
                    } else {
                        $vm.ResultModelExcel = res.data.itemsbypassPartial;
                    }
                });
