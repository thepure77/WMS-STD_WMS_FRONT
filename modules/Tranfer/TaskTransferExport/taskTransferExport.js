'use strict'
app.component('taskTransferExport', {
    controllerAs: '$vm',
    templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
        return "modules/Tranfer/TaskTransferExport/taskTransferExport.html";
    ...
    controller: function ($scope, $filter, $q, $compile, $http, /*ngAuthSettings,*/ $state, /*authService,*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, taskTransferExportFactory, webServiceAPI, logsFactory) {
        var $vm = this;
        var XFindItem = $filter('findItemList');
        var Progressbar = pageLoading;
        $scope.items = $scope.items || [];
        var viewModel = taskTransferExportFactory;
        ...
        $scope.filterTaskExport = function (param) {
            ...
            viewModel.filterTaskExport($scope.filterModel).then(function (res) {
        ...
        $scope.accepted = function (param) {
            ...
            if (!data) {
                ...
                $state.go('wms.scan_ref_Transfer_no_export_summary', {});
            }
        ...
        function serchPage(data) {
            ...
            if (data != null) {
                ...
                pageLoading.show();
                viewModel.filterTaskExport(data).then(function (res) {
                    pageLoading.hide();
