'use strict'
app.component('checkBypassForReplenishTableList', {
    controllerAs: '$vm',
    templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
        return "modules/Tranfer/CheckBypassForReplenish/CheckBypassForReplenish/checkBypassForReplenishTableList.html";
    },
    bindings: {
        searchResultModel: '=?',
        filterModel: '=?',
    ...
    controller: function ($scope, $filter, $q, $compile, $http, /*ngAuthSettings,*/ $state, /*authService,*/ pageLoading, $window, commonService , localStorageService, dpMessageBox, checkBypassForReplenishFactory) {
        var $vm = this;        
