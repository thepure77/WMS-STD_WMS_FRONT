(function () {
    'use strict';
    app.factory("taskTransferReplenishFactory",
        function ($q, $http, ngAuthSettings, localStorageService,  webServiceAPI, clientService) {
            ...
            return {
                ...
                url: webServiceAPI.GT + "ScanRefTransferNo",
                ...
                filterTask: function (model) {
                    ...
                    var urlRequest = this.url + "/FilterGoodsTransfer";
                    return clientService.post(urlRequest, model);
                },

                filterTaskReplenish: function (model) {
                    // var urlRequest = this.url + "/filter";
                    var urlRequest = this.url + "/FilterGoodsTransferReplenish";
                    return clientService.post(urlRequest, model);
                },
