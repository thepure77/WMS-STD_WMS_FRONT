...
(function () {
    'use strict'
    app.directive('cycleCountPopupTable', function () {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/component/Popup/cycleCountPopup/cycleCountPopupTable/cycleCountPopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
                        ...
                        dpMessageBox.alert(
                            {
                                ok: 'Close',
                                title: 'แจ้งเตือน',
                                message: 'กรุณาเลือกเลขที่ใบตรวจนับสินค้า'
                            }
                        )
                        return "";
                    }
