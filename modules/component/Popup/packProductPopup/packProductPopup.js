...
(function () {
    'use strict'
    app.directive('packProductPopup', ['ngAuthSettings', '$window', 'commonService', 'pageLoading', '$timeout',
        function (ngAuthSettings, $window, commonService, pageLoading, $timeout) {
            return {
                restrict: 'E',
                controllerAs: '$ctrl',
                templateUrl: "modules/component/Popup/packProductPopup/packProductPopup.html",
                scope: {
                    onShow: '=',
                    delegates: '=?',
                    invokes: '=?',
                ...
                controller: ['$scope', '$http', '$q', 'ngAuthSettings', '$state', 'pageLoading', '$window', 'commonService', '$timeout', '$translate', 'localStorageService', '$interval', 'productLineitemFactory',
                    function ($scope, $http, $q, ngAuthSettings, $state, pageLoading, $window, commonService, $timeout, $translate, localStorageService, $interval, productLineitemFactory) {
                        ...
                        $scope.delegates.productLineitemPopup = function (data) {
                            // $scope.dataset = angular.copy(param);
                            // $scope.items = angular.copy(data);
                            // $scope.productIndex = angular.copy(productIndex);
                            $scope.datalist.items = angular.copy(data);
                            if ($scope.datalist.delegates.set)
                            $scope.datalist.delegates.set(data);
