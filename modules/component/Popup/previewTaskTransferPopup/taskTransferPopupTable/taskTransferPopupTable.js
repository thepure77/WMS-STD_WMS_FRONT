...
(function () {
    'use strict'
    app.directive('taskTransferPopupTable', function () {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/component/Popup/previewTaskTransferPopup/taskTransferPopupTable/taskTransferPopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
