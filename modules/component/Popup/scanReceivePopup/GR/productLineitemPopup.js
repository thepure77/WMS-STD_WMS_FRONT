...
(function () {
    'use strict'
    app.directive('productLineitemPopup', ['ngAuthSettings', '$window', 'commonService', 'pageLoading', '$timeout',
        function (ngAuthSettings, $window, commonService, pageLoading, $timeout) {
            return {
                restrict: 'E',
                controllerAs: '$ctrl',
                templateUrl: "modules/component/Popup/scanReceivePopup/GR/productLineitemPopup.html",
                scope: {
                    onShow: '=',
                    delegates: '=?',
                    invokes: '=?',
                ...
                controller: ['$scope', '$http', '$q', 'ngAuthSettings', '$state', 'pageLoading', '$window', 'commonService', '$timeout', '$translate', 'localStorageService', '$interval', 'productLineitemFactory',
                    function ($scope, $http, $q, ngAuthSettings, $state, pageLoading, $window, commonService, $timeout, $translate, localStorageService, $interval, productLineitemFactory) {
                        $scope.delegates = {};
                        $scope.invokes = $scope.invokes || {};
                        $scope.config = $scope.config || {};
                        var viewModel = productLineitemFactory;
                        ...
                        $scope.delegates.productLineitemPopup = function (PlanGoodsReceive,index,productIndex) {
                            // $scope.dataset = angular.copy(param);
                            $scope.PlanGoodsReceive = angular.copy(PlanGoodsReceive);
                            $scope.PlanGoodsReceive.planGoodsReceive_Index = index;
                        ...
                        $scope.find = function () {
                            ...
                            $scope.search($scope.PlanGoodsReceive).then(function success(res) {
                                $scope.datalist.items = res.data;
