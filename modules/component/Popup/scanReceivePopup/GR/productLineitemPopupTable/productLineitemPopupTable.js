 ...
 (function() {
    'use strict'
    app.directive('productLineitemPopupTable', function() {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/component/Popup/scanReceivePopup/GR/productLineitemPopupTable/productLineitemPopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
