...
(function () {
    'use strict'
    app.directive('goodsTransferPopupTable', function () {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/component/Popup/goodsTransferPopup/goodsTransferPopupTable/goodsTransferPopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
