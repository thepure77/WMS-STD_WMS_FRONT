 ...
 (function() {
    'use strict'
    app.directive('productConversionPopTable', function() {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/component/Popup/productConversion/productConversionPopupTable/productConversionPopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
