...
(function () {
    'use strict'
    app.directive('planGiPopTableOfW', function () {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/component/Popup/planGiPopupOfW/planGiPopupTable/planGiPopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
            ...
            controller: ['$scope', 'commonService', '$filter', function ($scope, commonService, $filter) {
                ...
                $scope.delegate = {
                    set: function (model, paginations, documentTpye) {
                        if (paginations != null) {
                            $scope.pagging.totalRow = paginations.totalRow;
                        }
                        $scope.items = model;
                        $scope.documentTpye = documentTpye.documentType_Index != "d7c596e9-bdff-4759-91db-fcec709e16b8" ? true : false;
                    },
