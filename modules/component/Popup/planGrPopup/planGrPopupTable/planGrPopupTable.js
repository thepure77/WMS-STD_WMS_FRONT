...
(function () {
    'use strict'
    app.directive('planGrPopTable', function () {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/component/Popup/planGrPopup/planGrPopupTable/planGrPopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
            ...
            controller: ['$scope', 'commonService', '$filter', 'dpMessageBox', function ($scope, commonService, $filter, dpMessageBox) {
                ...
                $scope.selecteds = function (param) {
                    ...
                    {
                        var listPlanGRItem = [];
                        listPlanGRItem.push(param);

                        if ($scope.invokes.selected)
                        $scope.invokes.selected(listPlanGRItem);
                    }
