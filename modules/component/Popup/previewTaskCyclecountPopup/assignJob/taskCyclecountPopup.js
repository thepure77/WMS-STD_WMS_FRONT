...
(function () {
    'use strict'
app.directive('taskCyclecountPopup', ['ngAuthSettings', '$window', 'commonService', 'pageLoading', '$timeout',
function (ngAuthSettings, $window, commonService, pageLoading, $timeout) {
    return {
        restrict: 'E',
        controllerAs: '$ctrl',
        templateUrl: "modules/component/Popup/previewTaskCyclecountPopup/assignJob/taskCyclecountPopup.html",
        scope: {
            onShow: '=',
            delegates: '=?',
            invokes: '=?',
        ...
        controller: ['$scope', '$http', '$q', 'ngAuthSettings', '$state', 'pageLoading', '$window', 'commonService', '$timeout', '$translate', 'localStorageService', '$interval', 'assignJobCycleCountFactory',
            function ($scope, $http, $q, ngAuthSettings, $state, pageLoading, $window, commonService, $timeout, $translate, localStorageService, $interval, assignJobCycleCountFactory) {
                $scope.delegates = {};
                ...
                var viewModel = assignJobCycleCountFactory;
                        ...
                        $scope.delegates.taskCyclecountPopup = function (param) {
                        ...
                        $scope.find = function (data) {
                            $scope.task = $scope.task || {};
                            $scope.task.Chk = $scope.index;
                            $scope.task.cycleCount_Index = data.cycleCount_Index;
