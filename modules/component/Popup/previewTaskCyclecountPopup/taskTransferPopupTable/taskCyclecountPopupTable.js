...
(function () {
    'use strict'
    app.directive('taskCyclecountPopupTable', function () {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/component/Popup/previewTaskCyclecountPopup/taskTransferPopupTable/taskCyclecountPopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
