...
(function () {
    'use strict'
app.directive('taskPopup', ['ngAuthSettings', '$window', 'commonService', 'pageLoading', '$timeout',
function (ngAuthSettings, $window, commonService, pageLoading, $timeout) {
    return {
        restrict: 'E',
        controllerAs: '$ctrl',
        templateUrl: "modules/component/Popup/previewTaskPopup/assignJob/taskPopup.html",
        scope: {
            onShow: '=',
            delegates: '=?',
            invokes: '=?',
        ...
        controller: ['$scope', '$http', '$q', 'ngAuthSettings', '$state', 'pageLoading', '$window', 'commonService', '$timeout', '$translate', 'localStorageService', '$interval', 'assignJobFactory',
            function ($scope, $http, $q, ngAuthSettings, $state, pageLoading, $window, commonService, $timeout, $translate, localStorageService, $interval, assignJobFactory) {
                $scope.delegates = {};
                ...
                var viewModel = assignJobFactory;
                        ...
                        $scope.delegates.taskPopup = function (param) {
                        ...
                        $scope.find = function (data) {
                            $scope.task = $scope.task || {};
                            $scope.task.Chk = $scope.index;
                            $scope.task.goodsIssue_No = data.goodsIssue_No;
