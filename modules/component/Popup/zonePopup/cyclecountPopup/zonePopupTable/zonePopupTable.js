...
(function () {
    'use strict'
    app.directive('zonePopupTableCy', function () {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/component/Popup/zonePopup/cyclecountPopup/zonePopupTable/zonePopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
                ...
                $scope.delegate = {
                    set: function (model, paginations) {
                        ...
                        if (model.length != 0) {
                            ...
                            else if (model.itemsZone.length != 0) {
                                if ($scope.pagging.totalRow == 0) {
                                    $scope.pagging.totalRow = model.itemsZone.length;
                                }

                            }

                            if (model.itemsZone == undefined) {
                                $scope.items = model;
                            }
                            else {
                                $scope.items = model.itemsZone;
                            }
