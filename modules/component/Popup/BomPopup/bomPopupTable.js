...
(function () {
    'use strict'
    app.directive('bomPopupTable', function () {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/component/Popup/BomPopup/bomPopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
            ...
            controller: ['$scope', 'commonService', '$filter', function ($scope, commonService, $filter) {
                ...
                $scope.selected = function (param) {
                    ...
                    {
                        var listBomItem = [];
                        listBomItem.push(param);

                        if ($scope.invokes.selected)
                        $scope.invokes.selected(listBomItem);
                    }
                }
