...
'use strict'
app.directive('waveround', ['$parse', '$document', '$compile', 'optionParser',
    ...
    function($parse, $document, $compile, optionParser) {
        return {
            ...
            link: function(originalScope, element, attrs, modelCtrl) {
                ...
                var popUpEl = angular.element('<pc-select-multiselect-waveround></pc-select-multiselect-waveround>');
...
.directive('pcSelectMultiselectWaveround', ['$document', function($document) {
    return {
        restrict: 'E',
        scope: false,
        replace: true,
        templateUrl: 'modules/component/multipleSelect/waveround/view.html',
