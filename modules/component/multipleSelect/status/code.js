...
'use strict'
app.directive('status', ['$parse', '$document', '$compile', 'optionParser',
    ...
    function($parse, $document, $compile, optionParser) {
        return {
            ...
            link: function(originalScope, element, attrs, modelCtrl) {
                ...
                var popUpEl = angular.element('<pc-select-multiselect-popup></pc-select-multiselect-popup>');
...
.directive('pcSelectMultiselectPopup', ['$document', function($document) {
    return {
        restrict: 'E',
        scope: false,
        replace: true,
        templateUrl: 'modules/component/multipleSelect/status/view.html',
