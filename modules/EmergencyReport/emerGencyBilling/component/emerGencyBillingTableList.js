'use strict'
app.component('emerGencyBillingTableList', {
    controllerAs: '$vm',
    templateUrl: function ($element, $attrs, $window, commonService) {
        return "modules/EmergencyReport/emerGencyBilling/component/emerGencyBillingTableList.html";
    },
    bindings: {
        isLoading: '=?',
        searchResultModel: '=?',
    ...
    controller: function ($scope, $filter, $q, $compile, $http, /*ngAuthSettings,*/ $state, /*authService,*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, emerGencyBillingFactory) {
        var $vm = this;
