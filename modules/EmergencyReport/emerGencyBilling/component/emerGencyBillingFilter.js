(function () {
    'use strict';
    app.component('emerGencyBillingFilter', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/EmergencyReport/emerGencyBilling/component/emerGencyBillingFilter.html";
        },
        bindings: {
            searchResultModel: '=?',
            filterModel: '=?',
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, dpMessageBox, localStorageService, commonService, emerGencyBillingFactory, webServiceAPI, importFileFactory) {
            var $vm = this;

      
            var viewModel = emerGencyBillingFactory;
