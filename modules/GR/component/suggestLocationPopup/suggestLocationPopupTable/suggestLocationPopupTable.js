 ...
 (function() {
    'use strict'
    app.directive('suggestLocationPopupTable', function() {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/GR/component/suggestLocationPopup/suggestLocationPopupTable/suggestLocationPopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
