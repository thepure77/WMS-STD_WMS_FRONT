'use strict'
app.component('taskDockToStaging', {
    controllerAs: '$vm',
    templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
        return "modules/GR/putAway/dockToStaging/taskDockToStaging.html";
    ...
    controller: function ($scope, $filter, $q, $compile, $http, /*ngAuthSettings,*/ $state, /*authService,*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, putAwayFactory, webServiceAPI, logsFactory) {
        var $vm = this;
        ...
        $scope.filterTask = function (param) {
            ...
            viewModel.filterTaskDockToStaging($scope.filterModel).then(function (res) {
        ...
        $scope.accepted = function (param) {
            ...
            $scope.filterModel.taskGR_No = data.taskGR_No;
