'use strict'
app.component('importFileTransferTableList', {
    controllerAs: '$vm',
    templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
        return "modules/ImportFile/importFileTransfer/component/importFileTransferTableList.html";
    },
    bindings: {
        searchResultModel: '=?',
        invalidResultModel: '=?',
    ...
    controller: function ($scope, $filter, $q, $compile, $http, /*ngAuthSettings,*/ $state, /*authService,*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, importFileTransferFactory) {
        var $vm = this;
        ...
        $scope.save = function () {
            ...
            dpMessageBox.confirm({
                ...
                // if (route == "PlanGoodsReceive") {
                //     viewModel.confirmPGR({ Import_Index: $vm.guId.guId, Confirm_By: localStorageService.get('userTokenStorage') }).then(
                ...
                //     viewModel.confirmPGI({ Import_Index: $vm.guId.guId, Confirm_By: localStorageService.get('userTokenStorage') }).then(
                //         function success(res) {
                //             pageLoading.hide()
                //             dpMessageBox.alert({
                //                 ok: 'Yes',
                ...
                //         });
                // }
                viewModel.confirmTransfer({ Import_Index: $vm.guId.guId, Confirm_By: localStorageService.get('userTokenStorage') }).then(
                    function success(res) {
                        pageLoading.hide()
                        dpMessageBox.alert({
                            ok: 'Yes',
        ...
        $scope.back = function () {
            ...
            // if (route == "PlanGoodsReceive") {
            //     $state.go('wms.plan_summary');
            // }
            // else if (route == "PlanGoodsIssue") {
            //     $state.go('wms.plan_gi_summary');
            // }
        }
