'use strict'
app.component('importFileTableList', {
    controllerAs: '$vm',
    templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
        return "modules/ImportFile/importFile/component/importFileTableList.html";
    },
    bindings: {
        searchResultModel: '=?',
        invalidResultModel: '=?',
    ...
    controller: function ($scope, $filter, $q, $compile, $http, /*ngAuthSettings,*/ $state, /*authService,*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, importFileFactory) {
        var $vm = this;
        //var XFindItem = $filter('findItemList');
        var Progressbar = pageLoading;
        var viewModel = importFileFactory;
        $scope.items = [];
