(function () {
    'use strict';
    app.factory("historyCloseWaveFactory",
        function ($q, $http, ngAuthSettings, localStorageService, webServiceAPI, clientService) {
            ...
            return {
                ...
                url: webServiceAPI.Master + "HistoryCloseWave",
                urlWCS: webServiceAPI.WCS + "Wave",

                HistoryCloseWaveSearchSearch: function (model) {
                    var urlRequest = this.url + "/HistoryCloseWaveSearch";
                    return clientService.post(urlRequest, model);
                },
                
                Complete_Wave_45: function (model) {
                    var urlRequest = this.urlWCS + "/UPDATE_WMS_TBL_IF_WMS_WAVE_STATUS_CLOSE_STATUS45";
                    return clientService.post(urlRequest, model);
                }
            }
        });
