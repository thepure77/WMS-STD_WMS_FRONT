(function () {
    'use strict'
    app.directive('giMemoDetail', ['ngAuthSettings', '$window', 'commonService', 'pageLoading', '$timeout',
        function (ngAuthSettings, $window, commonService, pageLoading, $timeout) {
            return {
                restrict: 'E',
                controllerAs: '$ctrl',
                templateUrl: "modules/GI/Memo/component/giMemoDetail.html",
                scope: {
                    onShow: '=',
                    delegates: '=?',
                    invokes: '=?',
                ...
                controller: ['$scope', '$http', '$q', 'ngAuthSettings', '$state', 'pageLoading', '$window', 'commonService', '$timeout', '$translate', 'localStorageService', '$interval', 'webServiceAPI', 'giMemoFactory', 'dpMessageBox',
                    function ($scope, $http, $q, ngAuthSettings, $state, pageLoading, $window, commonService, $timeout, $translate, localStorageService, $interval, webServiceAPI, giMemoFactory, dpMessageBox) {
                        $scope.delegates = {};
                        ...
                        $scope.delegates = function (param) {
                            ...
                            if (param.rowItemIndex != undefined || param.rowItemIndex != null) {
                                ...
                                viewModel.getByGoodIssueId(param.index).then(function (res) {
