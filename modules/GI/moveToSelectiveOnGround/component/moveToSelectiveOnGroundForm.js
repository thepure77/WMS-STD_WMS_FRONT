(function () {
    ...
    app.component('moveToSelectiveOnGroundForm', {
        controllerAs: '$vm',
        templateUrl: "modules/GI/moveToSelectiveOnGround/component/moveToSelectiveOnGroundForm.html",
        bindings: {
            isLoading: '=?',
            onShow: '=?',
            searchResultModel: '=?',
        ...
        controller: function ($scope, $q, $filter, $http, $location, $anchorScroll, /*ngAuthSettings,*/ $state, /*authService*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, moveToSelectiveOnGroundFactory, moveToSelectiveOnGroundItemFactory, webServiceAPI) {
            var $vm = this;
            var defer = {};
            var viewModel = moveToSelectiveOnGroundFactory;
            var viewModelItem = moveToSelectiveOnGroundItemFactory;
            $scope.filterModel = {};
            $scope.filterModel2 = {};
