(function () {
    ...
    app.component('scanPickStgToDockForm', {
        controllerAs: '$vm',
        templateUrl: "modules/GI/scanPickStgToDock/component/scanPickStgToDockForm.html",
        bindings: {
            isLoading: '=?',
            onShow: '=?',
            searchResultModel: '=?',
        ...
        controller: function ($scope, $q, $filter, $http,$location,$anchorScroll, /*ngAuthSettings,*/ $state, /*authService*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, scanPickStgToDockFactory, scanPickStgToDockItemFactory, webServiceAPI) {
            var $vm = this;
            var defer = {};
            var viewModel = scanPickStgToDockFactory;
            var viewModelItem = scanPickStgToDockItemFactory;
            $scope.filterModel = {};
            $scope.filterModel2 = {};
