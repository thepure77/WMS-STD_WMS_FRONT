...
(function () {
    'use strict'
    app.directive('taskPickShortPopup', ['ngAuthSettings', '$window', 'commonService', 'pageLoading', '$timeout',
        function (ngAuthSettings, $window, commonService, pageLoading, $timeout) {
            return {
                restrict: 'E',
                controllerAs: '$ctrl',
                templateUrl: "modules/GI/component/TaskPickShort/taskPickShortPopup.html",
                scope: {
                    onShow: '=',
                    delegates: '=?',
                    invokes: '=?',
                ...
                controller: ['$scope', '$http', '$q', 'ngAuthSettings', '$state', 'pageLoading', '$window', 'commonService', '$timeout', '$translate', 'localStorageService', '$interval', 'shortPickingFactory',
                    function ($scope, $http, $q, ngAuthSettings, $state, pageLoading, $window, commonService, $timeout, $translate, localStorageService, $interval, shortPickingFactory) {
                        $scope.delegates = {};
                        ...
                        $scope.search = function (model) {
                            ...
                            if (model.mashalIndex != "" && model.mashalIndex!= null) {
                                viewModel.getTaskPickShort(model.mashalIndex).then(
