...
// (function () {
//     'use strict'
//     app.directive('documentTypePopupPlanGi', ['ngAuthSettings', '$window', 'commonService', 'pageLoading', '$timeout',
//         function (ngAuthSettings, $window, commonService, pageLoading, $timeout) {
//             return {
//                 restrict: 'E',
//                 controllerAs: '$ctrl',
//                 templateUrl: "modules/GI/component/documentTypePopup/documentTypePopup.html",
//                 scope: {
//                     onShow: '=',
//                     delegates: '=?',
//                     invokes: '=?',
//                     config: '=?'
//                 },
//                 controller: ['$scope', '$http', '$q', 'ngAuthSettings', '$state', 'pageLoading', '$window', 'commonService', '$timeout', '$translate', 'localStorageService', '$interval', 'documentTypePlanGiFactory',
//                     function ($scope, $http, $q, ngAuthSettings, $state, pageLoading, $window, commonService, $timeout, $translate, localStorageService, $interval, documentTypePlanGiFactory) {
//                         $scope.delegates = {};
//                         $scope.invokes = $scope.invokes || {};
//                         $scope.config = $scope.config || {};
//                         var viewModel = documentTypePlanGiFactory;
...
//                         // $scope.$watch("actionPS", function(newValue, oldValue){
//                         //     if(newValue == 1)
//                         //         $scope.documentType.documentTypeName = '';
//                         //     else
//                         //         $scope.documentType.documentTypeId = '';
//                         // });
//                         var init = function () {
