'use strict'
app.component('truckLoadTableList', {
    controllerAs: '$vm',
    templateUrl: function ($element, $attrs, $window, commonService) {
        return "modules/GI/truckLoad/component/truckLoadTableList.html";
    },
    bindings: {
        isLoading: '=?',
        searchResultModel: '=?',
    ...
    controller: function ($scope, $filter, $q, $compile, $http, /*ngAuthSettings,*/ $state, /*authService,*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, truckLoadFactory) {
        var $vm = this;
