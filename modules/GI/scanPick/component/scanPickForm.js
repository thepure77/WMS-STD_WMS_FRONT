(function () {
    ...
    app.component('scanPickForm', {
        controllerAs: '$vm',
        templateUrl: "modules/GI/scanPick/component/scanPickForm.html",
        bindings: {
            isLoading: '=?',
            onShow: '=?',
            searchResultModel: '=?',
        ...
        controller: function ($scope, $q, $filter, $http,$location,$anchorScroll, /*ngAuthSettings,*/ $state, /*authService*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, scanPickFactory, scanPickItemFactory, webServiceAPI) {
            var $vm = this;
            var defer = {};
            var viewModel = scanPickFactory;
            var viewModelItem = scanPickItemFactory;
            $scope.filterModel = {};
            $scope.filterModel2 = {};
