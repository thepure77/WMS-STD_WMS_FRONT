app.directive('acpBaggingPlanNo', function() {
    return {
        restrict: 'E',
        scope: {
            acModel: '=ngModel',
        ...
        controller: function($scope, $http, webServiceAPI, $timeout) {
            ...
            $scope.loadMatchList = function(val) {
                ...
                var requestUrl = 'planBagging/PlanNoSuggestion/'+ encodeURIComponent(val);
        ...
        templateUrl: 'modules/ModuleOms/widgets/acpBaggingPlanNo/view.html'
    }
});
