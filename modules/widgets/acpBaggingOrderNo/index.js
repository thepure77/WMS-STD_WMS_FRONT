app.directive('acpBaggingOrderNo', function() {
    return {
        restrict: 'E',
        scope: {
            acModel: '=ngModel',
        ...
        controller: function($scope, $http, webServiceAPI, $timeout) {
            ...
            $scope.loadMatchList = function(val) {
                ...
                var requestUrl = 'Bagging/OrderNoSuggestion/'+ encodeURIComponent(val);    
        ...
        templateUrl: 'modules/ModuleOms/widgets/acpBaggingOrderNo/view.html'
    }
});
