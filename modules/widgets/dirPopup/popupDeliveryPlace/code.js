(function () {
    ...
    app.directive('popupDeliveryPlace', ['ngAuthSettings', '$window', 'commonService', 'pageLoading', '$timeout',
        function (ngAuthSettings, $window, commonService, pageLoading, $timeout) {
            return {
                restrict: 'E',
                controllerAs: '$ctrl',
                templateUrl: "modules/ModuleOms/widgets/dirPopup/popupDeliveryPlace/view.html",
                scope: {
                    onShow: '=',
                    delegates: '=?',
                    invokes: '=?',
