(function () {
    ...
    app.directive('popupPackging', ['ngAuthSettings', '$window', 'commonService', 'pageLoading', '$timeout',
        function (ngAuthSettings, $window, commonService, pageLoading, $timeout) {
            return {
                restrict: 'E',
                controllerAs: '$ctrl',
                templateUrl: "modules/ModuleOms/widgets/dirPopup/popupPackaging/view.html",
                scope: {
                    onShow: '=',
                    delegates: '=?',
                    invokes: '=?',
