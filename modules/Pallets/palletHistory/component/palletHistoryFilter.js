(function () {
    'use strict';
    app.component('palletHistoryFilter', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, $window, commonService) {
            return "modules/Pallets/palletHistory/component/palletHistoryFilter.html";
        },
        bindings: {
            searchResultModel: '=?',
            filterModel: '=?',
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, pageLoading, dpMessageBox, localStorageService, commonService, addPalletFactory, webServiceAPI,importFileFactory) {
            var $vm = this;
            ...
            $scope.filterSearch = function () {
                ...
                $scope.filterModel.is_sum = false;
            ...
            function ExportExcel() {
                ...
                var deferred = $q.defer();
                $scope.filterModel.excelName = "Report Pallets History";
            ...
            $scope.autoComplete = {
                ...
                document: "Autocomplete/autoDocument",
            };
            $scope.url = {
