(function () {
    ...
    app.component('palletHistoryForm', {
        controllerAs: '$vm',
        templateUrl: "modules/Pallets/palletHistory/component/palletHistoryForm.html",
        bindings: {
            isLoading: '=?',
            onShow: '=?',
            searchResultModel: '=?',
        ...
        controller: function ($scope, $q, $filter, $http, /*ngAuthSettings,*/ $state, /*authService*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, palletHistoryFactory, purchaseOrderItemFactory, planGoodsIssueItemFactory, ownerPopFactory, webServiceAPI, Upload) {
            var $vm = this;

            var defer = {};
            var viewModel = palletHistoryFactory;
            var _viewModel = palletHistoryFactory
