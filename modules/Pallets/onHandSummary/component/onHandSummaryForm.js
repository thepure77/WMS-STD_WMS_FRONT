(function () {
    'use strict'
    app.component('onHandSummaryForm', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/Pallets/onHandSummary/component/onHandSummaryForm.html";
        },
        bindings: {
            onShow: '=?',
            searchResultModel: '=?',
        ...
        controller: function ($scope, $q, $filter, /*ngAuthSettings,*/ $state, /*authService*/ pageLoading, $window, dpMessageBox,localStorageService, onHandSummaryFactory,/*soldToFactory,*/ webServiceAPI) {
            var $vm = this;
