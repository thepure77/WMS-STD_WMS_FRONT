(function () {
  ...
  app.component("returnToteHistory", {
    controllerAs: "$vm",
    templateUrl: "modules/Pallets/returnToteHistory/returnToteHistory.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      var $vm = this;
      var viewModel = returnToteHistoryFactory;
      ...
      $scope.$watch("filterModel.product_Index", function () {
        if ($scope.filterModel.product_Index == "") {
            ...
            $scope.filterModel.product_Index = undefined;
            $scope.filterModel.product_Name = undefined;
            debugger
        }
    });
      function getToday() {
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "Report Check Balance All Prdouct";
      ...
      function insertLogsUser() {
        ...
        logs.menu_Index = "EF487A92-65D0-48E7-818B-B58E85B07596";
        //logs.menuType_Index
        //logs.menu_Id
        ...
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "Check Balance All Location";
        logs.operations = "";
