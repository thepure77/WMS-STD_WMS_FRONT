(function () {
    'use strict';
    app.factory("scanPickLabelingExportFactory",
        function ($q, $http, ngAuthSettings, localStorageService, webServiceAPI, clientService) {
            ...
            return {
                ...
                filter: function (model) {
                    var urlRequest = this.urlFillter + "/FilterTaskLabelingExport";
                ...
                ScanConfirm: function (model) {
                    var urlRequest = this.url + "/ScanConfirmLabeling";
                ...
                ScanLocaton: function (model) {
                    var urlRequest = this.url + "/ScanLocatonLabeling";
                    return clientService.post(urlRequest, model);
                },
