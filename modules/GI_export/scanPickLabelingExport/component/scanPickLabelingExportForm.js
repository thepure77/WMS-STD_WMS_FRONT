(function () {
    ...
    app.component('scanPickLabelingExportForm', {
        controllerAs: '$vm',
        templateUrl: "modules/GI_export/scanPickLabelingExport/component/scanPickLabelingExportForm.html",
        bindings: {
            isLoading: '=?',
            onShow: '=?',
            searchResultModel: '=?',
        ...
        controller: function ($scope, $q, $filter, $http,$location,$anchorScroll, /*ngAuthSettings,*/ $state, /*authService*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, scanPickLabelingExportFactory, scanPickLabelingItemExportFactory, webServiceAPI) {
            var $vm = this;
            var defer = {};
            var viewModel = scanPickLabelingExportFactory;
            var viewModelItem = scanPickLabelingItemExportFactory;
            $scope.filterModel = {};
            $scope.filterModel2 = {};
            ...
            $scope.confirmPick = function () {
                ...
                // }
                    ...
                    $scope.filterModel.operations = "SCAN CONFIRM "+$scope.filterModel.task_No;
