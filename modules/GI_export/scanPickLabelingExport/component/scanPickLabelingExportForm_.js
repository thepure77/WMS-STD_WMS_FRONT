(function () {
    ...
    app.component('scanPickLabelingForm', {
        controllerAs: '$vm',
        templateUrl: "modules/GI/scanPickLabeling/component/scanPickLabelingForm.html",
        bindings: {
            isLoading: '=?',
            onShow: '=?',
            searchResultModel: '=?',
        ...
        controller: function ($scope, $q, $filter, $http,$location,$anchorScroll, /*ngAuthSettings,*/ $state, /*authService*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, scanPickLabelingFactory, scanPickLabelingItemFactory, webServiceAPI) {
            var $vm = this;
            var defer = {};
            var viewModel = scanPickLabelingFactory;
            var viewModelItem = scanPickLabelingItemFactory;
            $scope.filterModel = {};
            $scope.filterModel2 = {};
