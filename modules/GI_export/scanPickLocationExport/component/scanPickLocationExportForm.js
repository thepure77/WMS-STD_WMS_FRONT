(function () {
    ...
    app.component('scanPickLocationExportForm', {
        controllerAs: '$vm',
        templateUrl: "modules/GI_export/scanPickLocationExport/component/scanPickLocationExportForm.html",
        bindings: {
            isLoading: '=?',
            onShow: '=?',
            searchResultModel: '=?',
        ...
        controller: function ($scope, $q, $filter, $http, $location, $anchorScroll, /*ngAuthSettings,*/ $state, /*authService*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, scanPickLocationFactory, scanPickLocationItemFactory, webServiceAPI) {
            var $vm = this;
            var defer = {};
            var viewModel = scanPickLocationFactory;
            var viewModelItem = scanPickLocationItemFactory;
            $scope.filterModel = {};
            $scope.filterModel2 = {};
                ...
                viewModelItem.GetDataScanTaskItem(param).then(function (res) {
                    ...
                    if (res.data.resultIsUse) {
                        ...
                        if (res.data.itemsDetail.length > 0) {
                            ...
                            $scope.filterModel.suggestlocation = 'STG-SE-XXX'
