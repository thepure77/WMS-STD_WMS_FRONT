(function () {
    'use strict';
    app.factory("scanPickLocationExportFactory",
        function ($q, $http, ngAuthSettings, localStorageService, webServiceAPI, clientService) {
            ...
            return {
                ...
                urlFillter: webServiceAPI.GI + "ScanPickExport",
                urlLogsRequest: webServiceAPI.LogsUser + "Logs/insertLogsRequest",

                filter: function (model) {
                    var urlRequest = this.urlFillter + "/FilterTaskLocationLabelingExport";
                ...
                ScanConfirm: function (model) {
                    var urlRequest = this.url + "/ScanConfirmforPickingLocation";
                ...
                ScanLocaton: function (model) {
                    var urlRequest = this.url + "/ScanLocatonDock";
                    return clientService.post(urlRequest, model);
                },
