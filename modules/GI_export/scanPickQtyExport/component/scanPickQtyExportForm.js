(function () {
    ...
    app.component('scanPickQtyExportForm', {
        controllerAs: '$vm',
        templateUrl: "modules/GI_export/scanPickQtyExport/component/scanPickQtyExportForm.html",
        bindings: {
            isLoading: '=?',
            onShow: '=?',
            searchResultModel: '=?',
        ...
        controller: function ($scope, $q, $filter, $http, $location, $anchorScroll, /*ngAuthSettings,*/ $state, /*authService*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, scanPickQtyExportFactory, scanPickQtyItemExportFactory, webServiceAPI) {
            var $vm = this;
            var defer = {};
            var viewModel = scanPickQtyExportFactory;
            var viewModelItem = scanPickQtyItemExportFactory;
            $scope.filterModel = {};
            $scope.filterModelplan = {};
            $scope.filterModel2 = {};
                ...
                viewModel.ScanBarcode($scope.filterModel).then(function (res) {
                    ...
                    if (res.data.resultIsUse) {
                        if (res.data.itemsDetail.length > 0) {
                            ...
                            setTimeout(() => {
                                var focusElem = jQuery('input[ng-model="filterModel.confirm_location_Id"]');
                                focusElem[0].focus();
                            }, 200);
            ...
            //                 $scope.filterModel.pick_ProductConversion_Name = res.data.itemsDetail[0].pick_ProductConversion_Name;
            //                 $scope.filterModel.pick_ProductConversion_Ratio = res.data.itemsDetail[0].pick_ProductConversion_Ratio;
            //                 $scope.filterModel.isPickQty = true;
            //                 $scope.filterModel.isCarton = true;
            //                 setTimeout(() => {
            //                     document.getElementById("pick_Qty").focus();
            //                     document.getElementById("pick_QtyM").focus();
            //                 }, 200);
            //             }
            //         }
            //         else {
            ...
            $scope.scanLocation = function () {
                ...
                viewModel.ScanLocaton($scope.filterModel2).then(function (res) {
                    ...
                    if (res.data.length > 0) {
                        ...
                        $scope.filterModel.location_Index = undefined;
                        $scope.filterModel.location_Id = undefined;
            ...
            function search(param) {
                ...
                viewModelItem.GetDataScanTaskItem(param).then(function (res) {
                    ...
                    if (res.data.resultIsUse) {
                        ...
                        //     $scope.filterModel2.location_Index = "DF3D2410-FCBD-4C82-9F2E-65EE51A83F51";
                        //     $scope.filterModel2.location_Id = "WH7TOASRS";
                        //     $scope.filterModel2.location_Name = "WH7TOASRS";
                        //     $scope.filterModel2.confirmLocation = "WH7TOASRS";
