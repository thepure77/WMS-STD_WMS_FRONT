(function () {
    ...
    app.component('scanPickExportForm', {
        controllerAs: '$vm',
        templateUrl: "modules/GI_export/scanPickExport/component/scanPickExportForm.html",
        bindings: {
            isLoading: '=?',
            onShow: '=?',
            searchResultModel: '=?',
        ...
        controller: function ($scope, $q, $filter, $http,$location,$anchorScroll, /*ngAuthSettings,*/ $state, /*authService*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, scanPickExportFactory, scanPickItemExportFactory, webServiceAPI) {
            var $vm = this;
            var defer = {};
            var viewModel = scanPickExportFactory;
            var viewModelItem = scanPickItemExportFactory;
            $scope.filterModel = {};
            $scope.filterModel2 = {};
