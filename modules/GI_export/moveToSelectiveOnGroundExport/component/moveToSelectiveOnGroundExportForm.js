(function () {
    ...
    app.component('moveToSelectiveOnGroundExportForm', {
        controllerAs: '$vm',
        templateUrl: "modules/GI_export/moveToSelectiveOnGroundExport/component/moveToSelectiveOnGroundExportForm.html",
        bindings: {
            isLoading: '=?',
            onShow: '=?',
            searchResultModel: '=?',
        ...
        controller: function ($scope, $q, $filter, $http, $location, $anchorScroll, /*ngAuthSettings,*/ $state, /*authService*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, moveToSelectiveOnGroundExportFactory, moveToSelectiveOnGroundItemExportFactory, webServiceAPI) {
            var $vm = this;
            var defer = {};
            var viewModel = moveToSelectiveOnGroundExportFactory;
            var viewModelItem = moveToSelectiveOnGroundItemExportFactory;
            $scope.filterModel = {};
            $scope.filterModel2 = {};
