(function () {
    'use strict';
    app.factory("moveToSelectiveOnGroundExportFactory",
        function ($q, $http, ngAuthSettings, localStorageService, webServiceAPI, clientService) {
            ...
            return {
                ...
                filter: function (model) {
                    var urlRequest = this.url + "/FilterTaskMoveToSelective";
                    return clientService.post(urlRequest, model);
                },
                ScanBarcode: function (model) {
                    var urlRequest = this.url + "/ScantagMoveToSTG";
                ...
                ScanConfirm: function (model) {
                    var urlRequest = this.url + "/ScanConfirmforMoveToSTG";
                ...
                ScanLocaton: function (model) {
                    var urlRequest = this.url + "/ScanLocatonMoveToSTG";
                    return clientService.post(urlRequest, model);
                },
