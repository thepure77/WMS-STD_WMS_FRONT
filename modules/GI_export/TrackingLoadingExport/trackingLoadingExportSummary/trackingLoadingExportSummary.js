(function () {
    'use strict';
    app.component('trackingLoadingExportSummary', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/GI_export/TrackingLoadingExport/trackingLoadingExportSummary/trackingLoadingExportSummary.html";
        },
        bindings: {
            scanReceive: '=?',
            onShow: '=?'
        },
        controller: function ($scope, $q, $filter, $http, /*ngAuthSettings,*/ $state, /*authService*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, trackingLoadingExportFactory, webServiceAPI) {
            var $vm = this;
            var defer = {};
            var viewModel = trackingLoadingExportFactory;
            $scope.url = {
                GR: webServiceAPI.GR,
            };
            $scope.filterModel = {};
