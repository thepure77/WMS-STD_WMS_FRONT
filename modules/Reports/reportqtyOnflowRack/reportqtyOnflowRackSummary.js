(function () {
'use strict'
app.component('reportqtyOnflowRackSummary', {
    controllerAs: '$vm',
    templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
        return "modules/Reports/reportqtyOnflowRack/reportqtyOnflowRackSummary.html";
    ...
    controller: function ($scope, $filter, $q, $compile, $http, /*ngAuthSettings,*/ $state, /*authService,*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, reportqtyOnflowRackFactory, webServiceAPI, logsFactory) {
        var $vm = this;
        $scope.items = $scope.items || [];
        var viewModel = reportqtyOnflowRackFactory;
      ...
      $scope.export = function () {
        ...
        function serchPage(data) {
            ...
            if (data != null) {
                ...
                pageLoading.show();
                  viewModel.filterStockCartonFlow(data).then(function (res) {
                      pageLoading.hide();
        ...
        $scope.searchFilter = function () {
          ...
          pageLoading.show()
          viewModel.filterStockCartonFlow($scope.filterModel).then(
        ...
        $scope.filterSearch = function () {
          ...
          $scope.searchFilter($scope.filterModel).then(function success(res) {
            ...
            // pageLoading.show();
            // viewModel.filterStockCartonFlow($scope.filterModel).then(function (res) {
            //     pageLoading.hide();
            //     $vm.searchResultModel = res.data.itemsview;
            //     $vm.filterModel = $scope.filterModel;
            //     $vm.filterModel.totalRow = res.data.pagination.totalRow;
        ...
        $scope.getLocationType = function () {
          viewModel.getLocationType({}).then(function (res) {
            ...
            // debugger;
            // $scope.dropdownLocationType = $scope.dropdownLocationType.filter(c => c.locationType_Name == "Carousel" || c.locationType_Name == "FlowRack");
          });
        };
