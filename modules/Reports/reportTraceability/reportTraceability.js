(function () {
  ...
  app.component("reportTraceability", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportTraceability/reportTraceability.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportTraceabilityFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportTraceabilityFactory;
      ...
      //   } 
        ...
        $scope.filterModel.excelName = "Report Traceability (In + Out)";
