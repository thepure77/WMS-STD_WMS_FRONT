(function () {
  ...
  app.component("report5", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/report5/report5Summary.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      $scope.searchReport = function (param) {
        if ($scope.filterModel.product_Id == undefined || $scope.filterModel.product_Id == "") {
          dpMessageBox.alert({
            ok: 'Close',
            title: 'Validate',
            message: 'กรุณากรอกเลขที่สินค้า'
          })
          return "";
        }
        if ($scope.filterModel.date != null) {
      ...
      $scope.url = {
        ...
        Report: webServiceAPI.Report,
          ...
          function ExportExcel() {
            ...
            $scope.filterModel.excelName = "สรุปการจ่ายสินค้า";
      ...
      function insertLogsUser()
      {
          ...
          logs.sub_Menu_Index = "DD59EF70-34B2-4A30-9997-AFE1C4F19482";
          //logs.sub_MenuType_Index
          //logs.sub_Menu_Id
          logs.sub_Menu_Name = "สรุปการจ่ายสินค้า";
          logs.operations = "";
