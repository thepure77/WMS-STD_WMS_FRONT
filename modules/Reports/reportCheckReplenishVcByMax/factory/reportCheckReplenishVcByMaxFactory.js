(function () {
    'use strict';
    app.factory("reportCheckReplenishVcByMaxFactory",
        function ($q, $http, ngAuthSettings, localStorageService,  webServiceAPI, clientService) {
 
            return {
                get: clientService.get,
                post: clientService.post,
                url: webServiceAPI.Report + "ReportCheckReplenishVCByMax",
                ...
                PrintReport: function (model) {
                    var urlRequest = this.url+ "/printReportCheckReplenishVCByMax";
