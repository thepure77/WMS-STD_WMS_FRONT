(function () {
  ...
  app.component("reportCheckReplenishVcByMax", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportCheckReplenishVcByMax/reportCheckReplenishVcByMax.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportCheckReplenishVcByMaxFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportCheckReplenishVcByMaxFactory;
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "Report Check Replenish VC By Max";
      ...
      function insertLogsUser() {
        ...
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "Report Check Replenish VC By Max";
        logs.operations = "";
