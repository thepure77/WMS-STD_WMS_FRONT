(function () {
  ...
  app.component("report12", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/report12/report12Summary.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      $scope.url = {
        Master: webServiceAPI.Master,
          ...
          function ExportExcel() {
            ...
            $scope.filterModel.excelName = "สรุปการใช้พื้นที่ตามประเภทสินค้า";
      ...
      function insertLogsUser()
      {
          ...
          logs.sub_Menu_Index = "ADE6102C-2A9D-4134-A654-4837770D10A0";
          //logs.sub_MenuType_Index
          //logs.sub_Menu_Id
          logs.sub_Menu_Name = "สรุปการใช้พื้นที่ตามประเภทสินค้า";
          logs.operations = "";
