(function () {
  ...
  app.component("reportCheckTotePendingReturn", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportCheckTotePendingReturn/reportCheckTotePendingReturn.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportCheckTotePendingReturnFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportCheckTotePendingReturnFactory;
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "Report Check Tote Pending Return";
      ...
      function insertLogsUser() {
        ...
        logs.menu_Index = "7021B33E-F478-4337-9C3A-56984FC9BF69";
        //logs.menuType_Index
        //logs.menu_Id
        ...
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "Report Check Tote Pending Return";
        logs.operations = "";
