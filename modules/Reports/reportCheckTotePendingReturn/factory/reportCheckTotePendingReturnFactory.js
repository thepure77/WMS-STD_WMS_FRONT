(function () {
    'use strict';
    app.factory("reportCheckTotePendingReturnFactory",
        function ($q, $http, ngAuthSettings, localStorageService,  webServiceAPI, clientService) {
 
            return {
                get: clientService.get,
                post: clientService.post,
                url: webServiceAPI.Report + "ReportCheckTotePendingReturn",
                ...
                PrintReport: function (model) {
                    var urlRequest = this.url+ "/printReportCheckTotePendingReturn";
