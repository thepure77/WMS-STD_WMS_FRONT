(function () {
    'use strict';
    app.factory("reportPerformanceFactory",
        function ($q, $http, ngAuthSettings, localStorageService,  webServiceAPI, clientService) {
 
            return {
                get: clientService.get,
                post: clientService.post,
                url: webServiceAPI.Report + "ReportPerformance",
                // url: "http://10.106.159.10/AMZ_WMS_ReportAPI/api/ReportPerformance",
                ...
                PrintReport: function (model) {
                    var urlRequest = this.url+ "/printReportPerformance";
