(function () {
  ...
  app.component("reportPerformanceSummary", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportPerformance/reportPerformanceSummary.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportPerformanceFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportPerformanceFactory;
      ...
      $scope.autoComplete = {
        ...
        autoOwnerID: "ReportPerformance/autoSearchOwnerID",
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "รายงานสรุปผลการปฏิบัติงาน";
      ...
      function insertLogsUser() {
        ...
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "รายงานสรุปผลการปฏิบัติงาน";
        logs.operations = "";
