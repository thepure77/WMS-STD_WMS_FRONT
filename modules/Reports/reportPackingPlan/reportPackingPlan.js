(function () {
  ...
  app.component("reportPackingPlan", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportPackingPlan/reportPackingPlan.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportPackingPlanFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportPackingPlanFactory;
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "Report Packing Plan";
      ...
      function insertLogsUser() {
        ...
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "Report Packing Plan";
        logs.operations = "";
