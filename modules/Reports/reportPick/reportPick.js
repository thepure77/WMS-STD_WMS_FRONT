(function () {
  ...
  app.component("reportPick", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportPick/reportPick.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      var $vm = this;
      var viewModel = reportPickFactory;
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "Report Packing List";
      ...
      function insertLogsUser() {
        ...
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "Report Packing List";
        logs.operations = "";
