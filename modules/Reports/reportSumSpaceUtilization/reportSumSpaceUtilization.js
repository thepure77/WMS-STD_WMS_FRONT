(function () {
  ...
  app.component("reportSumSpaceUtilization", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportSumSpaceUtilization/reportSumSpaceUtilization.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportSumSpaceUtilizationFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportSumSpaceUtilizationFactory;
      ...
      $scope.checkDate = function () {
        if ($scope.filterModel.report_Date != null) 
        {
          var str = $scope.filterModel.report_Date;
        ...
        if ($scope.filterModel.report_Date_To != null) 
        {
          var str2 = $scope.filterModel.report_Date_To;
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "Report SpaceUtilization";
      ...
      function insertLogsUser() {
        ...
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "Report Space Utilization";
        logs.operations = "";
