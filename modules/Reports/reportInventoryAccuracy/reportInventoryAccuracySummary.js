(function () {
  ...
  app.component("reportInventoryAccuracySummary", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportInventoryAccuracy/reportInventoryAccuracySummary.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportInventoryAccuracyFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportInventoryAccuracyFactory;
      ...
      $scope.searchReport = function (param) {
        ...
        if ($scope.dropdownItemStatus) {
          if ($scope.dropdownItemStatus.model != null) {
            ...
            param.itemStatus_Index = null;
            param.itemStatus_Id = null;
            param.itemStatus_Name = null;
          }
        }
        pageLoading.show();
      ...
      $scope.autoComplete = {
        ...
        autoOwnerID: "reportInventoryAccuracy/autoSearchOwnerID",
      ...
      function ExportExcel() {
        ...
        if ($scope.dropdownItemStatus) {
          if ($scope.dropdownItemStatus.model != null) {
            ...
            $scope.filterModel.itemStatus_Index = null;
            $scope.filterModel.itemStatus_Id = null;
            $scope.filterModel.itemStatus_Name = null;
          }
        }
        var deferred = $q.defer();
        $scope.filterModel.excelName = "รายงานการหมุนเวียนของคลัง";
      ...
      function insertLogsUser() {
        ...
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "รายงานการหมุนเวียนของคลัง";
        logs.operations = "";
