(function () {
    'use strict';
    app.factory("reportInventoryAccuracyFactory",
        function ($q, $http, ngAuthSettings, localStorageService,  webServiceAPI, clientService) {
 
            return {
                get: clientService.get,
                post: clientService.post,
                url: webServiceAPI.Report + "ReportInventoryAccuracy",
                // url: "http://10.106.159.10/AMZ_WMS_ReportAPI/api/ReportInventoryAccuracy",
                ...
                PrintReport: function (model) {
                    var urlRequest = this.url+ "/printReportInventoryAccuracy";
                    // var urlRequest = this.url+ "/TestReport";
