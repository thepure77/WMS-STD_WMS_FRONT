(function () {
  ...
  app.component("summaryCycleCount", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/SummaryCycleCount/summaryCycleCount.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      summaryCycleCountFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = summaryCycleCountFactory;
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "Report Cycle Count";
      ...
      function insertLogsUser() {
        ...
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "Report Cycle Count";
        logs.operations = "";
