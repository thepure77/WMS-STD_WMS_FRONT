(function () {
  ...
  app.component("reportGiByShipmentNoProductId", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportGIByShipmentNoProductID/reportGiByShipmentNoProductId.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportGiByShipmentNoProductIdFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportGiByShipmentNoProductIdFactory;
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "Report GI by Shipment No & Product ID";
      ...
      function insertLogsUser() {
        ...
        logs.menu_Index = "705D4781-FC0B-47C3-98A4-F2FA0B46F102";
        //logs.menuType_Index
        //logs.menu_Id
        ...
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "Report GI by Shipment No & Product ID";
        logs.operations = "";
