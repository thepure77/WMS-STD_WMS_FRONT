(function () {
    'use strict';
    app.factory("reportGiByShipmentNoProductIdFactory",
        function ($q, $http, ngAuthSettings, localStorageService,  webServiceAPI, clientService) {
 
            return {
                get: clientService.get,
                post: clientService.post,
                url: webServiceAPI.Report + "ReportGIByShipmentNoAndProductId",
                ...
                PrintReport: function (model) {
                    var urlRequest = this.url+ "/printReportGIByShipmentNoAndProductId";
