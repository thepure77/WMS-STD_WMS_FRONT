(function () {
  ...
  app.component("checkReplenishCfrByMax", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/checkReplenishCfrByMax/checkReplenishCfrByMax.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      checkReplenishCfrByMaxFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = checkReplenishCfrByMaxFactory;
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "Report Check Replenish CFR By Max";
      ...
      function insertLogsUser() {
        ...
        logs.menu_Index = "BBF0B25F-F604-400D-ABAA-0296BD5F67D7";
        //logs.menuType_Index
        //logs.menu_Id
        ...
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "Check Replenish CFR By Max";
        logs.operations = "";
