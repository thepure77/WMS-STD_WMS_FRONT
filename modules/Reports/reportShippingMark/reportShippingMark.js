(function () {
  ...
  app.component("reportShippingMark", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportShippingMark/reportShippingMark.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportShippingMarkFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportShippingMarkFactory;
      ...
      $scope.searchReport = function (param) {
        ...
        if($scope.filterModel.date != null || $scope.filterModel.date != "")
        {
          $scope.convertDate();
        }
        if (param.warehouse == undefined || param.warehouse == "" || param.warehouse == null ) {
          dpMessageBox.alert({
              ok: 'Close',
              title: 'Validate',
      ...
      function ExportExcel() {
        ...
        if ($scope.filterModel.warehouse == undefined || $scope.filterModel.warehouse == "" || $scope.filterModel.warehouse == null ) {
          dpMessageBox.alert({
              ok: 'Close',
              title: 'Validate',
              message: 'กรุณาเลือกคลัง'
        ...
        $scope.filterModel.excelName = "Report Shipping Mark";
      ...
      function insertLogsUser() {
        ...
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "Report Shipping Mark";
        logs.operations = "";
