(function () {
  ...
  app.component("reportNotMovement", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportNotMovement/reportNotMovement.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportNotMovementFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportNotMovementFactory;
