(function () {
  ...
  app.component("reportLaborIncentiveScheme", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportLaborIncentiveScheme/reportLaborIncentiveScheme.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportLaborIncentiveSchemeFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportLaborIncentiveSchemeFactory;
