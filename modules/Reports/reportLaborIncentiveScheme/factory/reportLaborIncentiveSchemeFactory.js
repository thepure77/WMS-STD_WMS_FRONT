(function () {
    'use strict';
    app.factory("reportLaborIncentiveSchemeFactory",
        function ($q, $http, ngAuthSettings, localStorageService,  webServiceAPI, clientService) {
 
            return {
                get: clientService.get,
                post: clientService.post,
                url: webServiceAPI.Report + "ReportLaborIncentiveScheme",
                ...
                PrintReport: function (model) {
                    var urlRequest = this.url+ "/printReportLaborIncentiveScheme";
