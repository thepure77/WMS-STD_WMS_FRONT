(function () {
  ...
  app.component("report20", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/report20/report20Summary.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      function insertLogsUser()
      {
          ...
          logs.sub_Menu_Index = "361AC954-590C-4A89-B19A-60D6B428F83F";
          //logs.sub_MenuType_Index
          //logs.sub_Menu_Id
          logs.sub_Menu_Name = "สรุปสินค้าที่ไม่มีการเคลื่อนไหว";
          logs.operations = "";
      ...
      $scope.convertDate = function () {
        ...
        if ($scope.filterModel.date != null) {
          ...
          function ExportExcel() {
            ...
            $scope.filterModel.excelName = "สรุปสินค้าที่ไม่มีการเคลื่อนไหว";
