(function () {
    'use strict';
    app.factory("reportStockbyZoneReportAgegingFactory",
        function ($q, $http, ngAuthSettings, localStorageService,  webServiceAPI, clientService) {
 
            return {
                get: clientService.get,
                post: clientService.post,
                url: webServiceAPI.Report + "ReportStockbyZoneReportAgeging",
                ...
                PrintReport: function (model) {
                    var urlRequest = this.url+ "/printReportStockbyZoneReportAgeging";
