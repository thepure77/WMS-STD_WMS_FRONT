(function () {
  ...
  app.component("report11", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/report11/report11Summary.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      $scope.url = {
        ...
        Report: webServiceAPI.Report,
          ...
          function ExportExcel() {
            ...
            $scope.filterModel.excelName = "สรุปพื้นที่คงเหลือ";
      ...
      function insertLogsUser()
      {
          ...
          //logs.sub_Menu_Id
          logs.sub_Menu_Name = "สรุปพื้นที่คงเหลือ";
          logs.operations = "";
