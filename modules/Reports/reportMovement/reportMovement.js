(function () {
  ...
  app.component("reportMovement", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportMovement/reportMovement.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportMovementFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportMovementFactory;
      ...
      $scope.hide = function () {
        ...
        if($scope.filterModel.advanceSearch == true || $scope.filterModel.advanceSearch == false){
          ...
          // $scope.filterModel.warehouse_Type = "";
          // $scope.filterModel.businessUnitList = "";
          // $scope.filterModel.product_Id = "";
          // $scope.filterModel.product_Name = "";
          // $scope.filterModel.product_Lot = "";
          $scope.filterModel.exp = getToday();
      ...
      $scope.convertDate = function () {
        ...
        if ($scope.filterModel.goodsReceive_Date_ != null) {
          ...
          $scope.filterModel.goodsReceive_Date_Show = DStart.toString()+ "-" + MStart.toString()+ "-" + YStart.toString();
          ...
          $scope.filterModel.goodsReceive_Date_To_Show = DEnd.toString()+ "-" + MEnd.toString()+ "-" + YEnd.toString();
        }
