(function () {
  ...
  app.component("checkOrderNotPick", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/checkOrderNotPick/checkOrderNotPick.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      checkOrderNotPickFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = checkOrderNotPickFactory;
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "Report Check Order Not Pick";
      ...
      function insertLogsUser() {
        ...
        logs.menu_Index = "4F055B4F-A65A-4B84-AF98-99C7E8CD4BAD";
        //logs.menuType_Index
        //logs.menu_Id
        ...
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "Check Order Not Pick";
        logs.operations = "";
