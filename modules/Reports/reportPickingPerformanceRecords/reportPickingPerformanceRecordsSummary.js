(function () {
  ...
  app.component("reportPickingPerformanceRecordsSummary", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportPickingPerformanceRecords/reportPickingPerformanceRecordsSummary.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportPickingPerformanceRecordsFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportPickingPerformanceRecordsFactory;
      ...
      $scope.autoComplete = {
        ...
        autoOwnerID: "ReportPickingPerformanceRecords/autoSearchOwnerID",
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "รายงานการคัดแยกสินค้า";
