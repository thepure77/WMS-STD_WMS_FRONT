(function () {
  ...
  app.component("reportVolumeByShipToPickZone", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportVolumeByShipToPickZone/reportVolumeByShipToPickZone.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportVolumeByShipToPickZoneFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportVolumeByShipToPickZoneFactory;
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "Volume by Ship To & Pick Zone";
      ...
      function insertLogsUser() {
        ...
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "Volume by Ship To & Pick Zone";
        logs.operations = "";
