(function () {
    'use strict';
    app.factory("reportVolumeByShipToPickZoneFactory",
        function ($q, $http, ngAuthSettings, localStorageService,  webServiceAPI, clientService) {
 
            return {
                get: clientService.get,
                post: clientService.post,
                url: webServiceAPI.Report + "ReportVolumeByShipToPickZone",
                ...
                PrintReport: function (model) {
                    var urlRequest = this.url+ "/printReportVolumeByShipToPickZone";
