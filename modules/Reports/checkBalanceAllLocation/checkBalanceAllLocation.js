(function () {
  ...
  app.component("checkBalanceAllLocation", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/checkBalanceAllLocation/checkBalanceAllLocation.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      checkBalanceAllLocationFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = checkBalanceAllLocationFactory;
