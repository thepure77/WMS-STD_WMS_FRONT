(function () {
  ...
  app.component("reportStockAging", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportStockAging/reportStockAgingSummary.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportStockAgingFactory, 
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportStockAgingFactory;
      ...
      function getToday() {
        ...
        return yyyy.toString() + "/" + mm.toString() + "/" + dd.toString();
          ...
          function ExportExcel() {
            ...
            $scope.filterModel.excelName = "รายงานคำนวณอายุสต๊อกสินค้า";
      ...
      $scope.autoComplete = {
        ...
        autoOwnerID: "ReportStockAging/autoSearchOwnerID"
      };
