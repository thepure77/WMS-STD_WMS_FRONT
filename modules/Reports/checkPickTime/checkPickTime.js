(function () {
  ...
  app.component("checkPickTime", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/checkPickTime/checkPickTime.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      checkPickTimeFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = checkPickTimeFactory;
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "Report Check Pick Time";
      ...
      function insertLogsUser() {
        ...
        logs.menu_Index = "4E80F2E1-D963-4DF5-894E-588F55157E7D";
        //logs.menuType_Index
        //logs.menu_Id
        ...
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "Check Pick Time";
        logs.operations = "";
