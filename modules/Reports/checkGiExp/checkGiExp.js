(function () {
  ...
  app.component("checkGiExp", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/checkGiExp/checkGiExp.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      var $vm = this;
      var viewModel = checkGiExpFactory;
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "Report Check GI_EXP";
      ...
      function insertLogsUser() {
        ...
        logs.menu_Index = "8FF0DF98-368E-4CB8-BD31-CDF216E269C4";
        //logs.menuType_Index
        //logs.menu_Id
        ...
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "Check GI_EXP";
        logs.operations = "";
