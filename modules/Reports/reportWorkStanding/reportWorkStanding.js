(function () {
  ...
  app.component("reportWorkStanding", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportWorkStanding/reportWorkStanding.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportWorkStandingFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportWorkStandingFactory;
