(function () {
  ...
  app.component("checkDimensionAllProduct", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/checkDimensionAllProduct/checkDimensionAllProduct.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      checkDimensionAllProductFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = checkDimensionAllProductFactory;
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "Report Dimension All Product";
      ...
      function insertLogsUser() {
        ...
        logs.menu_Index = "A30F6A92-D35C-4DB4-9081-B93A1A066B19";
        //logs.menuType_Index
        //logs.menu_Id
        ...
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "Check Dimension All Product";
        logs.operations = "";
