(function () {
  ...
  app.component("report4", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/report4/report4Summary.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "สรุปการแนะนำตำแหน่งจัดเก็บกับการเก็บจริง";
      ...
      function insertLogsUser() {
        ...
        logs.sub_Menu_Index = "66C5FBD9-FD6F-49FD-B2C9-9451EB98D4D4";
        //logs.sub_MenuType_Index
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "สรุปการแนะนำตำแหน่งจัดเก็บกับการเก็บจริง";
        logs.operations = "";
