(function () {
  ...
  app.component("reportSpaceUtilizationSummary", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportSpaceUtilization/reportSpaceUtilizationSummary.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportSpaceUtilizationFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportSpaceUtilizationFactory;
      ...
      $scope.autoComplete = {
        ...
        autoOwnerID: "reportSpaceUtilization/autoSearchOwnerID",
        ...
        LocationTypeName: "autoLocationType/autoSearchLocationTypeFilter",
      };
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "รายงานการใช้พื้นที่";
      ...
      function insertLogsUser() {
        ...
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "รายงานการใช้พื้นที่";
        logs.operations = "";
