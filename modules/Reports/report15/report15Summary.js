(function () {
  ...
  app.component("report15", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/report15/report15Summary.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      $scope.autoComplete = {
        ...
        autoOwnerID: "Report15/autoSearchOwnerID",
        autoMC: "Report15/autoSearchMC"
      };
      ...
      function insertLogsUser() {
        ...
        logs.sub_Menu_Index = "E9D5C17F-9025-4D60-8B90-3674C975930B";
        //logs.sub_MenuType_Index
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "สรุปสินค้าคงเหลือรายวัน";
        logs.operations = "";
      ...
      $scope.convertDate = function () {
        ...
        if ($scope.filterModel.date != null) {
          ...
          $scope.filterModel.binCard_date = YEnd.toString() + MEnd.toString() + DEnd.toString();
        }
          ...
          function ExportExcel() {
            ...
            $scope.filterModel.excelName = "สรุปสินค้าคงเหลือรายวัน";
