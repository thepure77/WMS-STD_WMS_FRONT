(function () {
  ...
  app.component("checkPlanGiandGidiff", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/checkPlanGiandGidiff/checkPlanGiandGidiff.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      checkPlanGiandGidiffFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = checkPlanGiandGidiffFactory;
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "Report Check Plan Giand Gidiff";
      ...
      function insertLogsUser() {
        ...
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "Check Plan Giand Gidiff";
        logs.operations = "";
