(function () {
  ...
  app.component("reportCheckZonePutaway", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportCheckZonePutaway/reportCheckZonePutaway.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportCheckZonePutawayFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportCheckZonePutawayFactory;
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "Report Check Zone Putaway";
      ...
      function insertLogsUser() {
        ...
        logs.menu_Index = "7DAC4B8B-D30C-48E0-95C2-442CD54E12DA";
        //logs.menuType_Index
        //logs.menu_Id
        ...
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "Report Check Zone Putaway";
        logs.operations = "";
