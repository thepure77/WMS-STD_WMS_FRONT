(function () {
  ...
  app.component("reportLaborPerformanceSummary", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportLaborPerformance/reportLaborPerformanceSummary.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportLaborPerformanceFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportLaborPerformanceFactory;
