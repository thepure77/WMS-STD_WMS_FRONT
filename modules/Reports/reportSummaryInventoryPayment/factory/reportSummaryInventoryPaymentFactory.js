(function () {
    'use strict';
    app.factory("reportSummaryInventoryPaymentFactory",
        function ($q, $http, ngAuthSettings, localStorageService,  webServiceAPI, clientService) {
 
            return {
                get: clientService.get,
                post: clientService.post,
                url: webServiceAPI.Report + "ReportSummaryInventoryPayment",
                ...
                PrintReport: function (model) {
                    var urlRequest = this.url+ "/printReportSummaryInventoryPayment";
