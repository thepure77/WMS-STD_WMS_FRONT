(function () {
  ...
  app.component("reportSummaryInventoryPayment", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportSummaryInventoryPayment/reportSummaryInventoryPaymentSummary.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportSummaryInventoryPaymentFactory, 
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportSummaryInventoryPaymentFactory;
      ...
      $scope.autoComplete = {
        ...
        autoOwnerID: "ReportSummaryInventoryPayment/autoSearchOwnerID",
    ...
    function ExportExcel() {
      ...
      $scope.filterModel.excelName = "รายงานการจ่ายสินค้า";
      ...
      function insertLogsUser()
      {
          ...
          //logs.sub_Menu_Id
          logs.sub_Menu_Name = "รายงานการจ่ายสินค้า";
          logs.operations = "";
