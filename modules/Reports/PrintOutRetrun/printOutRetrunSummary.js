(function() {
  "use strict";
  app.component("printOutRetrun", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/PrintOutRetrun/printOutRetrunSummary.html",
    controller: function(
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      printOutRetrunFactory, 
      logsFactory
    ) {
      var $vm = this;
      var viewModel = printOutRetrunFactory;
    ...
    $scope.hide = function () {
      ...
      function insertLogsUser()
      {
          ...
          logs.sub_Menu_Index = "ECE62964-78D3-4A1B-B972-53BA612412F5"
          //logs.sub_MenuType_Index
          //logs.sub_Menu_Id
          logs.sub_Menu_Name = "รายงานตรวจสอบการรับคืน";
          logs.operations = "";
      ...
      this.$onInit = function () {
        $scope.isShow = false;
        $scope.filterModel = {};
        $scope.filterModel.planGoodsReceive_Date_From = getToday();
    ...
    $scope.convertDate = function () {
      ...
      if ($scope.filterModel.date != null) {
          ...
          $scope.filterModel.planGoodsReceive_Date_From = YStart.toString() + MStart.toString() + DStart.toString();
