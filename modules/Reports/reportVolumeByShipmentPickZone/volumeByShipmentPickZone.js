(function () {
  ...
  app.component("volumeByShipmentPickZone", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportVolumeByShipmentPickZone/volumeByShipmentPickZone.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      volumeByShipmentPickZoneFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = volumeByShipmentPickZoneFactory;
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "Report Volume By Shipment PickZone";
