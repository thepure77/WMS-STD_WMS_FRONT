(function () {
  ...
  app.component("checkGrPutaway", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/checkGrPutaway/checkGrPutaway.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      checkGrPutawayFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = checkGrPutawayFactory;
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "Report Check Gr Putaway";
      ...
      function insertLogsUser() {
        ...
        logs.menu_Index = "A64B3B3F-5EC5-41E4-B119-976B74C57BBB";
        //logs.menuType_Index
        //logs.menu_Id
        ...
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "Check Gr Putaway";
        logs.operations = "";
