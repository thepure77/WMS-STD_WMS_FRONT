(function () {
  ...
  app.component("reportFinishGoods", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportFinishGoods/reportFinishGoodsSummary.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportFinishGoodsFactory, 
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportFinishGoodsFactory;
      ...
      $scope.convertDate = function () {
        ...
        if ($scope.filterModel.date != null) {
          ...
          $scope.filterModel.GoodsReceive_Date_Start = YStart.toString() + MStart.toString() + DStart.toString();

          var DEnd = str.substring(15, 13);
          var MEnd = str.substring(18, 16);
          var YEnd = str.substring(25, 19);

          $scope.filterModel.GoodsReceive_Date_End = YEnd.toString() + MEnd.toString() + DEnd.toString();
        }
      ...
      $scope.autoComplete = {
        Report: "ReportAutocomplete/autoOwnerBOM",
        autoOwnerID: "reportFinishGoods/autoSearchOwnerID"
      };
      ...
      function insertLogsUser()
      {
          ...
          //logs.sub_Menu_Id
          logs.sub_Menu_Name = "สรุปรายการสินค้าค้างรับตามใบสั่งซื้อ";
          logs.operations = "";
      ...
      $scope.$watch("filterModel.owner_Id + filterModel.owner_Index", function () {
        if ($scope.filterModel.owner_Index == "" || $scope.filterModel.owner_Index == undefined) {
          ...
          function ExportExcel() {
            ...
            $scope.filterModel.excelName = "สินค้านำเข้า Finish Goods";
