(function () {
  ...
  app.component("reportCheckTransactionGr", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportCheckTransactionGr/reportCheckTransactionGr.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportCheckTransactionGrFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportCheckTransactionGrFactory;
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "Report Check Transaction GR";
      ...
      function insertLogsUser() {
        ...
        logs.menu_Index = "70E6623B-83D2-40A5-8121-9EC331D48C20";
        //logs.menuType_Index
        //logs.menu_Id
        ...
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "Report Check Transaction GR";
        logs.operations = "";
