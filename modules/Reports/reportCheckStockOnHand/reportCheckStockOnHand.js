(function () {
  ...
  app.component("reportCheckStockOnHand", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportCheckStockOnHand/reportCheckStockOnHand.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportCheckStockOnHandFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportCheckStockOnHandFactory;
