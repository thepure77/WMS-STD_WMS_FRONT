(function () {
  ...
  app.component("reportCheckStockAvb", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportCheckStockAvb/reportCheckStockAvb.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportCheckStockAvbFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportCheckStockAvbFactory;
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "Report Check Stock AVB";
      ...
      function insertLogsUser() {
        ...
        logs.menu_Index = "956E83C4-BFF6-4AF7-A1C6-5DEDDB8DAC8D";
        //logs.menuType_Index
        //logs.menu_Id
        ...
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "Report Check Stock AVB";
        logs.operations = "";
