(function () {
  ...
  app.component("report13", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/report13/report13Summary.html",
    controller: function (
      $scope,
      $filter,
      $http,
    ...
    function ExportExcel() {
      ...
      $scope.filterModel.excelName = "วิเคราะห์ประสิทธิภาพการทำงาน";
      ...
      function insertLogsUser()
      {
          ...
          logs.sub_Menu_Index = "4717FFC0-2537-466E-B714-232DEF0EA2BD";
          //logs.sub_MenuType_Index
          //logs.sub_Menu_Id
          logs.sub_Menu_Name = "วิเคราะห์ประสิทธิภาพการทำงาน";
          logs.operations = "";
