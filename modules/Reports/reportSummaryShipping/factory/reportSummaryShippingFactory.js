(function () {
    'use strict';
    app.factory("reportSummaryShippingFactory",
        function ($q, $http, ngAuthSettings, localStorageService,  webServiceAPI, clientService) {
 
            return {
                get: clientService.get,
                post: clientService.post,
                url: webServiceAPI.Report + "ReportSummaryShipping",
                // url: "http://10.106.159.10/AMZ_WMS_ReportAPI/api/ReportSummaryShipping",
                ...
                PrintReport: function (model) {
                    var urlRequest = this.url+ "/printReportSummaryShipping";
