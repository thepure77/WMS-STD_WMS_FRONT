(function () {
  ...
  app.component("report17", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/report17/report17Summary.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      function getToday() {
        ...
        return yyyy.toString() + "/" + mm.toString() + "/" + dd.toString();
          ...
          function ExportExcel() {
            ...
            $scope.filterModel.excelName = "สรุปสินค้าเข้า-ออกรายเดือน";
      ...
      function insertLogsUser() {
        ...
        logs.sub_Menu_Index = "1108051D-1956-425E-BC8C-903291BDBECB";
        //logs.sub_MenuType_Index
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "สรุปสินค้าเข้า-ออกรายเดือน";
        logs.operations = "";
      ...
      this.$onInit = function () {
        ...
        $scope.filterModel.binCard_Date = "0";
        insertLogsUser();
      };
