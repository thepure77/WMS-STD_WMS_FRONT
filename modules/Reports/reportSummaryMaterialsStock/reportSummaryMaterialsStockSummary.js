(function () {
  ...
  app.component("reportSummaryMaterialsStock", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportSummaryMaterialsStock/reportSummaryMaterialsStockSummary.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportSummaryMaterialsStockFactory, 
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportSummaryMaterialsStockFactory;
      ...
      $scope.autoComplete = {
        ...
        autoOwner: "ReportAutocomplete/autoOwnerID",
      ...
      $scope.url = {
        ...
        Report: webServiceAPI.Report
          ...
          function ExportExcel() {
            ...
            $scope.filterModel.excelName = "รายงานสินค้าค้างเก็บ";
