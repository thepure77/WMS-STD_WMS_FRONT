(function () {
    'use strict';
    app.factory("reportSummaryMaterialsStockFactory",
        function ($q, $http, ngAuthSettings, localStorageService,  webServiceAPI, clientService) {
 
            return {
                get: clientService.get,
                post: clientService.post,
                url: webServiceAPI.Report + "ReportSummaryMaterialsStock",
                ...
                PrintReport: function (model) {
                    var urlRequest = this.url+ "/printReportSummaryMaterialsStock";
