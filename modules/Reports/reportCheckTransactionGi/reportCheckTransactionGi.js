(function () {
  ...
  app.component("reportCheckTransactionGi", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportCheckTransactionGi/reportCheckTransactionGi.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportCheckTransactionGiFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportCheckTransactionGiFactory;
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "Report Check Transaction GI";
      ...
      function insertLogsUser() {
        ...
        logs.menu_Index = "0275AEE5-8511-4764-970B-C4210FC4C330";
        //logs.menuType_Index
        //logs.menu_Id
        ...
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "Report Check Transaction GI";
        logs.operations = "";
