(function () {
  ...
  app.component("reportLaborUtilization", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportLaborUtilization/reportLaborUtilization.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportLaborUtilizationFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportLaborUtilizationFactory;
