(function () {
  ...
  app.component("reportInventoryStock", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportInventoryStock/reportInventoryStockSummary.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportInventoryStockFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportInventoryStockFactory;
      ...
      $scope.autoComplete = {
        ...
        autoProductType: "ReportAutocomplete/autoProductType",
        autoOwnerID: "ReportInventoryStock/autoSearchOwnerID"
        // autoProductType: "ReportAutocomplete/autoProductType",
      };
      ...
      function insertLogsUser() {
        ...
        logs.sub_Menu_Index = "27D5FBBC-A341-41E8-B6E8-8CE1EB6EEC04";
        //logs.sub_MenuType_Index
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "สรุปสินค้า";
        logs.operations = "";
      ...
      $scope.$watch("filterModel.productType_Id + filterModel.productType_Index", function () {
        if ($scope.filterModel.productType_Index == "" || $scope.filterModel.productType_Index == undefined) {
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "รายงานสินค้าคงคลัง";
