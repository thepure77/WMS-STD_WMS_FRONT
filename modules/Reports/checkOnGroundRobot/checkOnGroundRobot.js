(function () {
  ...
  app.component("checkOnGroundRobot", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/checkOnGroundRobot/checkOnGroundRobot.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      checkOnGroundRobotFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = checkOnGroundRobotFactory;
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "Report Check On Ground Robot";
      ...
      function insertLogsUser() {
        ...
        logs.menu_Index = "AF66304B-97DD-422B-BC59-5A6486586615";
        //logs.menuType_Index
        //logs.menu_Id
        ...
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "Check On Ground Robot";
        logs.operations = "";
