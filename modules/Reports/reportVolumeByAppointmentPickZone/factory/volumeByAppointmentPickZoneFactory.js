(function () {
    'use strict';
    app.factory("volumeByAppointmentPickZoneFactory",
        function ($q, $http, ngAuthSettings, localStorageService,  webServiceAPI, clientService) {
 
            return {
                get: clientService.get,
                post: clientService.post,
                url: webServiceAPI.Report + "VolumeByAppointmentPickZone",
                ...
                PrintReport: function (model) {
                    var urlRequest = this.url+ "/printVolumeByAppointmentPickZone";
