(function () {
  ...
  app.component("volumeByAppointmentPickZone", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportVolumeByAppointmentPickZone/volumeByAppointmentPickZone.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      volumeByAppointmentPickZoneFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = volumeByAppointmentPickZoneFactory;
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "Report Volume By Appointment Pick Zone";
