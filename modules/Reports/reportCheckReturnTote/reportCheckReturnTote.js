(function () {
  ...
  app.component("reportCheckReturnTote", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportCheckReturnTote/reportCheckReturnTote.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportCheckReturnToteFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportCheckReturnToteFactory;
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "Report Check Return Tote";
      ...
      function insertLogsUser() {
        ...
        logs.menu_Index = "DE721D4A-7284-486E-9D47-3391EEED574B";
        //logs.menuType_Index
        //logs.menu_Id
        ...
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "Report Check Return Tote";
        logs.operations = "";
