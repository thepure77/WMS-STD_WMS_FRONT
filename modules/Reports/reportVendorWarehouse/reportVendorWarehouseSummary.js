(function () {
  ...
  app.component("reportVendorWarehouse", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportVendorWarehouse/reportVendorWarehouseSummary.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportVendorWarehouseFactory, 
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportVendorWarehouseFactory;
      ...
      function getToday() {
        ...
        return yyyy.toString() + "/" + mm.toString() + "/" + dd.toString();
          ...
          function ExportExcel() {
            ...
            $scope.filterModel.excelName = "รายงานการใช้งานพื้นที่คลังสินค้าของ Vendor";
      ...
      $scope.autoComplete = {
        ...
        autoOwner: "Autocomplete/autoOwner",
        autoOwnerID: "ReportVendorWarehouse/autoSearchOwnerID"
      };
