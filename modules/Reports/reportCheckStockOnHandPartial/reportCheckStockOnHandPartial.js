(function () {
  ...
  app.component("reportCheckStockOnHandPartial", {
    controllerAs: "$vm",
    templateUrl: "modules/Reports/reportCheckStockOnHandPartial/reportCheckStockOnHandPartial.html",
    controller: function (
      $scope,
      $filter,
      $http,
      ...
      dpMessageBox,
      webServiceAPI,
      reportCheckStockOnHandPartialFactory,
      logsFactory
    ) {
      var $vm = this;
      var viewModel = reportCheckStockOnHandPartialFactory;
      ...
      function ExportExcel() {
        ...
        $scope.filterModel.excelName = "Report Check Stock On Hand Partial";
      ...
      function insertLogsUser() {
        ...
        logs.menu_Index = "F188EEC5-37FC-4600-AA27-A99AC11B4456";
        //logs.menuType_Index
        //logs.menu_Id
        ...
        //logs.sub_Menu_Id
        logs.sub_Menu_Name = "Report Check Stock On Hand Partial";
        logs.operations = "";
