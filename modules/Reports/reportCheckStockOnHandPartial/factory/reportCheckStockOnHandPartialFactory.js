(function () {
    'use strict';
    app.factory("reportCheckStockOnHandPartialFactory",
        function ($q, $http, ngAuthSettings, localStorageService,  webServiceAPI, clientService) {
 
            return {
                get: clientService.get,
                post: clientService.post,
                url: webServiceAPI.Report + "ReportCheckStockOnHandPartial",
                ...
                PrintReport: function (model) {
                    var urlRequest = this.url+ "/printReportCheckStockOnHandPartial";
