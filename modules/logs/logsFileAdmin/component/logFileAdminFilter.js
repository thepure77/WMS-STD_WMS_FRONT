(function () {
    'use strict';
    app.component('logFileAdminFilter', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, $window, commonService) {
            return "modules/logs/logsFileAdmin/component/logFileAdminFilter.html";
        },
        bindings: {
            searchResultModel: '=?',
            filterModel: '=?',
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, pageLoading, dpMessageBox, localStorageService, commonService, logFileAdimFactory, webServiceAPI) {
            var $vm = this;
            ...
            $scope.filterSearch = function () {
                ...
                if ($scope.dropdownMenu.model != null) {
                    ...
                    $vm.filterModel.menu_Index = $scope.filterModel.menu_Index;
                } else {
