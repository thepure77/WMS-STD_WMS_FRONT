(function () {
    'use strict';
    app.component('logGrFilter', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/logs/logGR/component/logGrFilter.html";
        },
        bindings: {
            searchResultModel: '=?',
            filterModel: '=?',
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService, logGrFactory, webServiceAPI, dpMessageBox) {
            var $vm = this;

            // ----------------------------------------------------
            // This default object

            var viewModel = logGrFactory;
            ...
            //     $vm.filterModel.PlanGoodsReceive_Due_Date = $vm.filterModel.PlanGoodsReceive_Due_Date || getToday();
            //     $vm.filterModel.PlanGoodsReceive_Due_Date_To = $vm.filterModel.PlanGoodsReceive_Due_Date_To|| getToday();
            //     pageLoading.show();
            //     viewModel.filter($vm.filterModel).then(function (res) {
            //         pageLoading.hide();
            //         $vm.filterModel.PlanGoodsReceive_Due_Date = getToday();
            //         if (res.data.itemsLoggr.length != 0) {
            ...
            //             $vm.searchResultModel = res.data.itemsLoggr;
            //         }
            //         else {
            //             $vm.searchResultModel = res.data.itemsLoggr;
            //         }
            ...
            $scope.filterSearch = function () {
                ...
                $scope.filterModel.PlanGoodsReceive_Due_Date = $vm.filterModel.PlanGoodsReceive_Due_Date || getToday();
                $scope.filterModel.PlanGoodsReceive_Due_Date_To = $vm.filterModel.PlanGoodsReceive_Due_Date_To|| getToday();
                debugger
            ...
            $scope.exportFile = {
              ...
              function Export() {
                ...
                pageLoading.show();
                var deferred = $q.defer();
                $scope.filterModel.excelName = "Log GR";
            ...
            this.$onInit = function () {
                ...
                $scope.filterModel.PlanGoodsReceive_Due_Date_To = getToday();
                initialize();
            };
        }
    });
