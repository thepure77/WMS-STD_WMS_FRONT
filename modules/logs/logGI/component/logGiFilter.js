(function () {
    'use strict';
    app.component('logGiFilter', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/logs/logGI/component/logGiFilter.html";
        },
        bindings: {
            searchResultModel: '=?',
            filterModel: '=?',
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService, logGiFactory, webServiceAPI,dpMessageBox) {
            var $vm = this;

            // ----------------------------------------------------
            // This default object

            var viewModel = logGiFactory;
            ...
            //     $vm.filterModel.PlanGoodsIssue_Due_Date = $vm.filterModel.PlanGoodsIssue_Due_Date || getToday();
            //     $vm.filterModel.PlanGoodsIssue_Due_Date_To = $vm.filterModel.PlanGoodsIssue_Due_Date_To|| getToday();
            //     pageLoading.show();
            //     viewModel.filter($vm.filterModel).then(function (res) {
            //         pageLoading.hide();
            //         $vm.filterModel.PlanGoodsIssue_Due_Date = getToday();
            //         if (res.data.itemsLoggi.length != 0) {
            ...
            //             $vm.searchResultModel = res.data.itemsLoggi;
            //         }
            //         else {
            //             $vm.searchResultModel = res.data.itemsLoggi;
            //         }
            ...
            $scope.filterSearch = function () {
                ...
                $scope.filterModel.PlanGoodsIssue_Due_Date = $vm.filterModel.PlanGoodsIssue_Due_Date || getToday();
                $scope.filterModel.PlanGoodsIssue_Due_Date_To = $vm.filterModel.PlanGoodsIssue_Due_Date_To|| getToday();
                debugger
            ...
            $scope.exportFile = {
              ...
              function Export() {
                ...
                pageLoading.show();
                var deferred = $q.defer();
                $scope.filterModel.excelName = "Log GI";
            ...
            this.$onInit = function () {
                ...
                $scope.filterModel.PlanGoodsIssue_Due_Date_To = getToday();
                initialize();
            };
        }
    });
