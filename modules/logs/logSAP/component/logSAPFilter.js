(function () {
    'use strict';
    app.component('logSapFilter', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/logs/logSAP/component/logSAPFilter.html";
        },
        bindings: {
            searchResultModel: '=?',
            filterModel: '=?',
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService, logSAPFactory, webServiceAPI) {
            var $vm = this;
            ...
            $vm.triggerSearch = function () {
                ...
                viewModel.filter($vm.filterModel).then(function (res) {
                    ...
                    if (res.data.length != 0) {
                        ...
                        $vm.searchResultModel = res.data.itemsLog;
                    }
                    else {
                        $vm.searchResultModel = res.data.itemsLog;
                    }
