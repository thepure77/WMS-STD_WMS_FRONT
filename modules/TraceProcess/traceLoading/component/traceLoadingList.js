'use strict'
app.component('traceLoadingList', {
    controllerAs: '$vm',
    templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
        return "modules/TraceProcess/traceLoading/component/traceLoadingList.html";
    },
    bindings: {
        isLoading: '=?',
        searchResultModel: '=?',
    ...
    controller: function ($scope, $filter, $q, $compile, $http, /*ngAuthSettings,*/ $state, /*authService,*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox,traceLoadingFactory) {
        var $vm = this;
        $scope.maxSize = 5;
        $scope.filterModel = {};
        $vm.isShow = false
