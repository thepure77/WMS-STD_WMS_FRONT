  ...
  var Renderer = function () {
    ...
    var tplDialogs = function (lang, options) {
      var tplImageDialog = function () {
        ...
        var footer = '<button href="#" class="btn btn-filter note-image-btn disabled" disabled>' + lang.image.insert + '</button>';
      ...
      var tplLinkDialog = function () {
        ...
        var footer = '<button href="#" class="btn btn-filter note-link-btn disabled" disabled>' + lang.link.insert + '</button>';
      ...
      var tplVideoDialog = function () {
        var body = '<div class="form-group">' +
                   ...
                   '</div>';
        var footer = '<button href="#" class="btn btn-filter note-video-btn disabled" disabled>' + lang.video.insert + '</button>';
